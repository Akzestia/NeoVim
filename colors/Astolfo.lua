-- colors/Astolfo.lua
-- Auto-generated from astolfo.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Astolfo"

local c = {
  bg           = "#1a1c19", -- textEditorBackground
  bg_dark      = "#141513", -- secondaryBackground
  bg_header    = "#181917", -- headerColor
  bg_base      = "#171816", -- baseBackground
  bg_caret     = "#20221f", -- caretRow
  bg_select    = "#501C1C", -- selectionBackground
  bg_search    = "#753B78", -- searchBackground
  bg_fold      = "#211D1E", -- foldedTextBackground
  bg_diff_del  = "#242424", -- diff.deleted
  bg_diff_add  = "#172215", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#6f6f6f", -- disabledColor
  fg_comment   = "#8e856e", -- lineNumberColor
  fg_line_nr   = "#8e856e", -- lineNumberColor
  accent       = "#d58d9c", -- accentColor
  accent_stop  = "#eecc4b", -- stopColor
  accent_comp  = "#f3d594", -- iconAccentCompliment
  cyan         = "#a7a0d1", -- constantColor
  yellow       = "#f5c9fc", -- classNameColor
  pink         = "#d776ae", -- keywordColor
  green        = "#cd5257", -- stringColor
  blue         = "#e87bc3", -- htmlTagColor
  key_green    = "#f6ebb7", -- keyColor
  purple       = "#efa2da", -- iconSecondaryBlend
  border       = "#212220", -- borderColor
  red          = "#FF5555",
}
