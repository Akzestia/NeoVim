-- colors/Asuna_Light.lua
-- Auto-generated from asuna.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Asuna_Light"

local c = {
  bg           = "#fcfcfc", -- textEditorBackground
  bg_dark      = "#fcfcfc", -- secondaryBackground
  bg_header    = "#fdfdfd", -- headerColor
  bg_base      = "#ffffff", -- baseBackground
  bg_caret     = "#feeeee", -- caretRow
  bg_select    = "#e9b4b8", -- selectionBackground
  bg_search    = "#F8E728", -- searchBackground
  ...
  accent       = "#a61d0d", -- accentColor
  accent_stop  = "#ec081e", -- stopColor
  accent_comp  = "#ec8e00", -- iconAccentCompliment
  cyan         = "#4C94D6", -- constantColor
  yellow       = "#C68741", -- classNameColor
  pink         = "#a61d0d", -- keywordColor
  green        = "#a61d0d", -- stringColor
