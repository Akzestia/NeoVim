-- colors/Azuki.lua
-- Auto-generated from azuki.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Azuki"

local c = {
  bg           = "#2e221f", -- textEditorBackground
  bg_dark      = "#291e1b", -- secondaryBackground
  bg_header    = "#2d221f", -- headerColor
  bg_base      = "#322623", -- baseBackground
  bg_caret     = "#382a26", -- caretRow
  bg_select    = "#684e29", -- selectionBackground
  bg_search    = "#542626", -- searchBackground
  bg_fold      = "#3b2c27", -- foldedTextBackground
  bg_diff_del  = "#383234", -- diff.deleted
  bg_diff_add  = "#2b2b1e", -- testScopeColor
  fg           = "#bfbfbf", -- foregroundColor
  fg_dim       = "#5b606f", -- disabledColor
  fg_comment   = "#6c635a", -- lineNumberColor
  fg_line_nr   = "#6c635a", -- lineNumberColor
  accent       = "#e9b14e", -- accentColor
  accent_stop  = "#e6c678", -- stopColor
  accent_comp  = "#ba8274", -- iconAccentCompliment
  cyan         = "#efacfc", -- constantColor
  yellow       = "#c4ff8d", -- classNameColor
  pink         = "#ffad46", -- keywordColor
  green        = "#e0f6bf", -- stringColor
  blue         = "#f585ab", -- htmlTagColor
  key_green    = "#96f3fd", -- keyColor
  purple       = "#af766e", -- iconSecondaryBlend
  border       = "#403331", -- borderColor
  red          = "#FF5555",
}
