-- colors/Beatrice.lua
-- Auto-generated from beatrice.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Beatrice"

local c = {
  bg           = "#FFE5F1", -- textEditorBackground
  bg_dark      = "#f5c1d4", -- secondaryBackground
  bg_header    = "#FFE0F0", -- headerColor
  bg_base      = "#ffe4f1", -- baseBackground
  bg_caret     = "#ffdce6", -- caretRow
  bg_select    = "#fcc9f2", -- selectionBackground
  bg_search    = "#dc99bb", -- searchBackground
  bg_fold      = "#F1E5FA", -- foldedTextBackground
  bg_diff_del  = "#EBD1DE", -- diff.deleted
  bg_diff_add  = "#ede8e4", -- testScopeColor
  fg           = "#000000", -- foregroundColor
  fg_dim       = "#ceaec7", -- disabledColor
  fg_comment   = "#aaaaaa", -- lineNumberColor
  fg_line_nr   = "#aaaaaa", -- lineNumberColor
  accent       = "#78A5EB", -- accentColor
  accent_stop  = "#fbadff", -- stopColor
  accent_comp  = "#E94686", -- iconAccentCompliment
  cyan         = "#4C94D6", -- constantColor
  yellow       = "#df81b8", -- classNameColor
  pink         = "#C869A3", -- keywordColor
  green        = "#DC872E", -- stringColor
  blue         = "#C64EA1", -- htmlTagColor
  key_green    = "#7C75EF", -- keyColor
  purple       = "#539bec", -- iconSecondaryBlend
  border       = "#F1D7E6", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#232323" })
