-- colors/C_C_.lua
-- Auto-generated from cc.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "C_C_"

local c = {
  bg           = "#C4EA8A", -- textEditorBackground
  bg_dark      = "#b5de76", -- secondaryBackground
  bg_header    = "#caec92", -- headerColor
  bg_base      = "#d2f69b", -- baseBackground
  bg_caret     = "#D0F09E", -- caretRow
  bg_select    = "#92d564", -- selectionBackground
  bg_search    = "#85CFF3", -- searchBackground
  bg_fold      = "#bbe27c", -- foldedTextBackground
  bg_diff_del  = "#B6D489", -- diff.deleted
  bg_diff_add  = "#b7e783", -- testScopeColor
  fg           = "#101010", -- foregroundColor
  fg_dim       = "#86a164", -- disabledColor
  fg_comment   = "#507433", -- lineNumberColor
  fg_line_nr   = "#507433", -- lineNumberColor
  accent       = "#68ac17", -- accentColor
  accent_stop  = "#eaa007", -- stopColor
  accent_comp  = "#194704", -- iconAccentCompliment
  cyan         = "#2B57A7", -- constantColor
  yellow       = "#7748B7", -- classNameColor
  pink         = "#0803A5", -- keywordColor
  green        = "#CB5A29", -- stringColor
  blue         = "#B31141", -- htmlTagColor
  key_green    = "#098776", -- keyColor
  purple       = "#1c7851", -- iconSecondaryBlend
  border       = "#a1bf75", -- borderColor
  red          = "#FF5555",
}
