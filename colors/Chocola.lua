-- colors/Chocola.lua
-- Auto-generated from chocola.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Chocola"

local c = {
  bg           = "#2c2729", -- textEditorBackground
  bg_dark      = "#282023", -- secondaryBackground
  bg_header    = "#2c2428", -- headerColor
  bg_base      = "#30292c", -- baseBackground
  bg_caret     = "#352f31", -- caretRow
  bg_select    = "#6a3849", -- selectionBackground
  bg_search    = "#235E52", -- searchBackground
  bg_fold      = "#393336", -- foldedTextBackground
  bg_diff_del  = "#383234", -- diff.deleted
  bg_diff_add  = "#282b27", -- testScopeColor
  fg           = "#d3d3d3", -- foregroundColor
  fg_dim       = "#6f5b64", -- disabledColor
  fg_comment   = "#6c5a63", -- lineNumberColor
  fg_line_nr   = "#6c5a63", -- lineNumberColor
  accent       = "#f771a3", -- accentColor
  accent_stop  = "#e66895", -- stopColor
  accent_comp  = "#85e2bf", -- iconAccentCompliment
  cyan         = "#96b7fb", -- constantColor
  yellow       = "#f8835f", -- classNameColor
  pink         = "#FF357C", -- keywordColor
  green        = "#F6E9CB", -- stringColor
  blue         = "#ff6b75", -- htmlTagColor
  key_green    = "#48eae4", -- keyColor
  purple       = "#866a7e", -- iconSecondaryBlend
  border       = "#3a3336", -- borderColor
  red          = "#FF5555",
}
