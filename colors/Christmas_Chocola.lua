-- colors/Christmas_Chocola.lua
-- Auto-generated from chocola.xmas.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Christmas_Chocola"

local c = {
  bg           = "#3a141d", -- textEditorBackground
  bg_dark      = "#2d0c13", -- secondaryBackground
  bg_header    = "#37131b", -- headerColor
  bg_base      = "#3c161f", -- baseBackground
  bg_caret     = "#4f1b27", -- caretRow
  bg_select    = "#1f422d", -- selectionBackground
  bg_search    = "#710E1B", -- searchBackground
  bg_fold      = "#491925", -- foldedTextBackground
  bg_diff_del  = "#263631", -- diff.deleted
  bg_diff_add  = "#1f2f27", -- testScopeColor
  fg           = "#d3d3d3", -- foregroundColor
  fg_dim       = "#65515c", -- disabledColor
  fg_comment   = "#6d816c", -- lineNumberColor
  fg_line_nr   = "#6d816c", -- lineNumberColor
  accent       = "#FFFFFE", -- accentColor
  accent_stop  = "#e66895", -- stopColor
  accent_comp  = "#ffffff", -- iconAccentCompliment
  cyan         = "#96b7fb", -- constantColor
  yellow       = "#e3ecf8", -- classNameColor
  pink         = "#f06b7e", -- keywordColor
  green        = "#ffe3cd", -- stringColor
  blue         = "#e14987", -- htmlTagColor
  key_green    = "#ebc190", -- keyColor
  purple       = "#f17685", -- iconSecondaryBlend
  border       = "#4b1c27", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#fefefe" })
