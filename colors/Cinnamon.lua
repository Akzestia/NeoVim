-- colors/Cinnamon.lua
-- Auto-generated from cinnamon.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Cinnamon"

local c = {
  bg           = "#343277", -- textEditorBackground
  bg_dark      = "#333184", -- secondaryBackground
  bg_header    = "#37357f", -- headerColor
  bg_base      = "#393784", -- baseBackground
  bg_caret     = "#3f3c91", -- caretRow
  bg_select    = "#3a6c75", -- selectionBackground
  bg_search    = "#5334D9", -- searchBackground
  bg_fold      = "#3b3886", -- foldedTextBackground
  bg_diff_del  = "#3B4267", -- diff.deleted
  bg_diff_add  = "#343f79", -- testScopeColor
  fg           = "#f3edff", -- foregroundColor
  fg_dim       = "#a08fb8", -- disabledColor
  fg_comment   = "#ffffff", -- lineNumberColor
  fg_line_nr   = "#ffffff", -- lineNumberColor
  accent       = "#54e255", -- accentColor
  accent_stop  = "#98ff3d", -- stopColor
  accent_comp  = "#6eea70", -- iconAccentCompliment
  cyan         = "#8bc1f8", -- constantColor
  yellow       = "#d0a2fa", -- classNameColor
  pink         = "#53dac7", -- keywordColor
  green        = "#b3a9ff", -- stringColor
  blue         = "#f3ff83", -- htmlTagColor
  key_green    = "#FFD448", -- keyColor
  purple       = "#9685fd", -- iconSecondaryBlend
  border       = "#413e96", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#e7e9ff" })
