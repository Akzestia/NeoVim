-- colors/Coconut.lua
-- Auto-generated from coconut.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Coconut"

local c = {
  bg           = "#312b3a", -- textEditorBackground
  bg_dark      = "#2d2735", -- secondaryBackground
  bg_header    = "#312c3a", -- headerColor
  bg_base      = "#3a3143", -- baseBackground
  bg_caret     = "#393243", -- caretRow
  bg_select    = "#255b82", -- selectionBackground
  bg_search    = "#635628", -- searchBackground
  bg_fold      = "#383142", -- foldedTextBackground
  bg_diff_del  = "#373645", -- diff.deleted
  bg_diff_add  = "#2e3637", -- testScopeColor
  fg           = "#d3d3d3", -- foregroundColor
  fg_dim       = "#625b6f", -- disabledColor
  fg_comment   = "#605a6c", -- lineNumberColor
  fg_line_nr   = "#605a6c", -- lineNumberColor
  accent       = "#d2b503", -- accentColor
  accent_stop  = "#e5e66f", -- stopColor
  accent_comp  = "#dd8cf8", -- iconAccentCompliment
  cyan         = "#50b5d1", -- constantColor
  yellow       = "#f689f6", -- classNameColor
  pink         = "#b897f6", -- keywordColor
  green        = "#F6E9CB", -- stringColor
  blue         = "#ff858c", -- htmlTagColor
  key_green    = "#48eae4", -- keyColor
  purple       = "#6c89fd", -- iconSecondaryBlend
  border       = "#453b4e", -- borderColor
  red          = "#FF5555",
}
