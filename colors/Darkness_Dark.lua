-- colors/Darkness_Dark.lua
-- Auto-generated from darkness.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Darkness_Dark"

local c = {
  bg           = "#0a0904", -- textEditorBackground
  bg_dark      = "#100d03", -- secondaryBackground
  bg_header    = "#090802", -- headerColor
  bg_base      = "#080703", -- baseBackground
  bg_caret     = "#14110d", -- caretRow
  bg_select    = "#553919", -- selectionBackground
  bg_search    = "#144824", -- searchBackground
  bg_fold      = "#191813", -- foldedTextBackground
  bg_diff_del  = "#33342F", -- diff.deleted
  ...
  accent       = "#e99745", -- accentColor
  accent_stop  = "#ee6a12", -- stopColor
  accent_comp  = "#f5e0c5", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#d53a4a", -- classNameColor
  pink         = "#ffba2f", -- keywordColor
  green        = "#4593f5", -- stringColor
  blue         = "#a28a92", -- htmlTagColor
  key_green    = "#3492b1", -- keyColor
  purple       = "#358aec", -- iconSecondaryBlend
  border       = "#1c1500", -- borderColor
  red          = "#FF5555",
}
