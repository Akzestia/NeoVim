-- colors/Darkness_Light.lua
-- Auto-generated from darkness.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Darkness_Light"

local c = {
  bg           = "#FFFEF9", -- textEditorBackground
  bg_dark      = "#fffff7", -- secondaryBackground
  bg_header    = "#FFFEF9", -- headerColor
  bg_base      = "#fefefa", -- baseBackground
  bg_caret     = "#FFF6E4", -- caretRow
  bg_select    = "#fff3b4", -- selectionBackground
  bg_search    = "#C1FFBA", -- searchBackground
  bg_fold      = "#F3F2E2", -- foldedTextBackground
  bg_diff_del  = "#E9E6DB", -- diff.deleted
  bg_diff_add  = "#D7FFDC", -- testScopeColor
  fg           = "#000000", -- foregroundColor
  fg_dim       = "#7F818F", -- disabledColor
  fg_comment   = "#aaaaaa", -- lineNumberColor
  fg_line_nr   = "#aaaaaa", -- lineNumberColor
  accent       = "#F5C83C", -- accentColor
  accent_stop  = "#FCFFA5", -- stopColor
  accent_comp  = "#28c29f", -- iconAccentCompliment
  cyan         = "#005CC5", -- constantColor
  yellow       = "#c79c19", -- classNameColor
  pink         = "#E36207", -- keywordColor
  green        = "#005CC5", -- stringColor
  blue         = "#22863a", -- htmlTagColor
  key_green    = "#3492b1", -- keyColor
  purple       = "#358aec", -- iconSecondaryBlend
  border       = "#f1f4e0", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#366906" })
