-- colors/Echidna.lua
-- Auto-generated from echidna.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Echidna"

local c = {
  bg           = "#121014", -- textEditorBackground
  bg_dark      = "#110f13", -- secondaryBackground
  bg_header    = "#171519", -- headerColor
  bg_base      = "#141216", -- baseBackground
  bg_caret     = "#1a171c", -- caretRow
  bg_select    = "#274540", -- selectionBackground
  bg_search    = "#5a3b5d", -- searchBackground
  bg_fold      = "#1b181d", -- foldedTextBackground
  bg_diff_del  = "#262626", -- diff.deleted
  bg_diff_add  = "#151b18", -- testScopeColor
  fg           = "#a8a8a8", -- foregroundColor
  fg_dim       = "#646464", -- disabledColor
  fg_comment   = "#6f7779", -- lineNumberColor
  fg_line_nr   = "#6f7779", -- lineNumberColor
  accent       = "#ECECEC", -- accentColor
  accent_stop  = "#7ceec8", -- stopColor
  accent_comp  = "#ffffff", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#EFA554", -- classNameColor
  pink         = "#8b8b8b", -- keywordColor
  green        = "#f4fa8c", -- stringColor
  blue         = "#8daeef", -- htmlTagColor
  key_green    = "#BD93F9", -- keyColor
  purple       = "#c67dfa", -- iconSecondaryBlend
  border       = "#1e2021", -- borderColor
  red          = "#FF5555",
}
