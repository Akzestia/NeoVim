-- colors/Emilia_Dark.lua
-- Auto-generated from emilia.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Emilia_Dark"

local c = {
  bg           = "#492d5a", -- textEditorBackground
  bg_dark      = "#4e2d62", -- secondaryBackground
  bg_header    = "#4c2e5c", -- headerColor
  bg_base      = "#4e3162", -- baseBackground
  bg_caret     = "#543466", -- caretRow
  bg_select    = "#5C3378", -- selectionBackground
  bg_search    = "#7749b2", -- searchBackground
  bg_fold      = "#402a54", -- foldedTextBackground
  bg_diff_del  = "#4E4151", -- diff.deleted
  bg_diff_add  = "#483658", -- testScopeColor
  fg           = "#DADADA", -- foregroundColor
  fg_dim       = "#AF9ECB", -- disabledColor
  fg_comment   = "#666879", -- lineNumberColor
  fg_line_nr   = "#666879", -- lineNumberColor
  accent       = "#a53ba0", -- accentColor
  accent_stop  = "#F667FF", -- stopColor
  accent_comp  = "#767379", -- iconAccentCompliment
  cyan         = "#FFB9A7", -- constantColor
  yellow       = "#FF9CD6", -- classNameColor
  pink         = "#EF69C3", -- keywordColor
  green        = "#FDEFA2", -- stringColor
  blue         = "#BF98F1", -- htmlTagColor
  key_green    = "#C1A2F8", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#553a63", -- borderColor
  red          = "#FF5555",
}
