-- colors/Emilia_Light.lua
-- Auto-generated from emilia.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Emilia_Light"

local c = {
  bg           = "#fbf0ff", -- textEditorBackground
  bg_dark      = "#faecff", -- secondaryBackground
  bg_header    = "#fbf0ff", -- headerColor
  bg_base      = "#fcf3ff", -- baseBackground
  bg_caret     = "#f1dcf7", -- caretRow
  bg_select    = "#c7a0d2", -- selectionBackground
  bg_search    = "#78c5ad", -- searchBackground
  bg_fold      = "#f2e5f6", -- foldedTextBackground
  ...
  accent       = "#82357d", -- accentColor
  accent_stop  = "#e984ed", -- stopColor
  accent_comp  = "#3bc9a2", -- iconAccentCompliment
  cyan         = "#4C94D6", -- constantColor
  yellow       = "#cb70a5", -- classNameColor
  pink         = "#90468c", -- keywordColor
  green        = "#0CA87E", -- stringColor
  blue         = "#2925AC", -- htmlTagColor
  key_green    = "#7C75EF", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#e9d8f6", -- borderColor
  red          = "#FF5555",
}
