-- colors/Essex.lua
-- Auto-generated from essex.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Essex"

local c = {
  bg           = "#001d39", -- textEditorBackground
  bg_dark      = "#002f5d", -- secondaryBackground
  bg_header    = "#00203e", -- headerColor
  bg_base      = "#002446", -- baseBackground
  bg_caret     = "#261a30", -- caretRow
  bg_select    = "#480F0F", -- selectionBackground
  bg_search    = "#14447C", -- searchBackground
  bg_fold      = "#00274e", -- foldedTextBackground
  bg_diff_del  = "#112938", -- diff.deleted
  bg_diff_add  = "#02293b", -- testScopeColor
  fg           = "#d7d7d7", -- foregroundColor
  fg_dim       = "#5b646f", -- disabledColor
  fg_comment   = "#5d7685", -- lineNumberColor
  fg_line_nr   = "#5d7685", -- lineNumberColor
  accent       = "#D53232", -- accentColor
  accent_stop  = "#e51515", -- stopColor
  accent_comp  = "#B5AAEE", -- iconAccentCompliment
  cyan         = "#78DBEF", -- constantColor
  yellow       = "#B5AAEE", -- classNameColor
  pink         = "#EE4C4C", -- keywordColor
  green        = "#f3b085", -- stringColor
  blue         = "#DB3B46", -- htmlTagColor
  key_green    = "#eec45e", -- keyColor
  purple       = "#8beaff", -- iconSecondaryBlend
  border       = "#002c55", -- borderColor
  red          = "#FF5555",
}
