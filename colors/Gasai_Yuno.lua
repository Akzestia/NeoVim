-- colors/Gasai_Yuno.lua
-- Auto-generated from yuno.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Gasai_Yuno"

local c = {
  bg           = "#150713", -- textEditorBackground
  bg_dark      = "#130511", -- secondaryBackground
  bg_header    = "#1a0717", -- headerColor
  bg_base      = "#1a081a", -- baseBackground
  bg_caret     = "#230920", -- caretRow
  bg_select    = "#602b50", -- selectionBackground
  bg_search    = "#403B98", -- searchBackground
  bg_fold      = "#240a24", -- foldedTextBackground
  bg_diff_del  = "#211C21", -- diff.deleted
  bg_diff_add  = "#181d16", -- testScopeColor
  fg           = "#c8c8c8", -- foregroundColor
  fg_dim       = "#505050", -- disabledColor
  fg_comment   = "#796675", -- lineNumberColor
  fg_line_nr   = "#796675", -- lineNumberColor
  accent       = "#ffa0b2", -- accentColor
  accent_stop  = "#ffa5b0", -- stopColor
  accent_comp  = "#45c46d", -- iconAccentCompliment
  cyan         = "#34a7d1", -- constantColor
  yellow       = "#EFA554", -- classNameColor
  pink         = "#e0474b", -- keywordColor
  green        = "#F6E3CC", -- stringColor
  blue         = "#8d82ea", -- htmlTagColor
  key_green    = "#39e6a6", -- keyColor
  purple       = "#6196fa", -- iconSecondaryBlend
  border       = "#300c30", -- borderColor
  red          = "#FF5555",
}
