-- colors/Genos.lua
-- Auto-generated from genos.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Genos"

local c = {
  bg           = "#313234", -- textEditorBackground
  bg_dark      = "#232529", -- secondaryBackground
  bg_header    = "#252627", -- headerColor
  bg_base      = "#2f3031", -- baseBackground
  bg_caret     = "#3f4143", -- caretRow
  bg_select    = "#605d51", -- selectionBackground
  bg_search    = "#9A561A", -- searchBackground
  bg_fold      = "#27282a", -- foldedTextBackground
  bg_diff_del  = "#40474E", -- diff.deleted
  bg_diff_add  = "#233125", -- testScopeColor
  fg           = "#dbdbdb", -- foregroundColor
  fg_dim       = "#566171", -- disabledColor
  fg_comment   = "#80755d", -- lineNumberColor
  fg_line_nr   = "#80755d", -- lineNumberColor
  accent       = "#ddc7a1", -- accentColor
  accent_stop  = "#faf58fff", -- stopColor
  accent_comp  = "#56aef5", -- iconAccentCompliment
  cyan         = "#EA7777", -- constantColor
  yellow       = "#B39CFF", -- classNameColor
  pink         = "#8ACAFF", -- keywordColor
  green        = "#FF984B", -- stringColor
  blue         = "#FCA3C8", -- htmlTagColor
  key_green    = "#FFE35C", -- keyColor
  purple       = "#FFE35C", -- iconSecondaryBlend
  border       = "#3b3c3e", -- borderColor
  red          = "#FF5555",
}
