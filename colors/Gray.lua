-- colors/Gray.lua
-- Auto-generated from gray.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Gray"

local c = {
  bg           = "#35393b", -- textEditorBackground
  bg_dark      = "#363e3e", -- secondaryBackground
  bg_header    = "#363b3d", -- headerColor
  bg_base      = "#3b3f41", -- baseBackground
  bg_caret     = "#353d41", -- caretRow
  bg_select    = "#295043", -- selectionBackground
  bg_search    = "#3F6F80", -- searchBackground
  bg_fold      = "#3c4443", -- foldedTextBackground
  bg_diff_del  = "#3f4244", -- diff.deleted
  bg_diff_add  = "#2e3f3a", -- testScopeColor
  fg           = "#b0b0b0", -- foregroundColor
  fg_dim       = "#6f6f6f", -- disabledColor
  fg_comment   = "#556c6a", -- lineNumberColor
  fg_line_nr   = "#556c6a", -- lineNumberColor
  accent       = "#4ed4b0", -- accentColor
  accent_stop  = "#597cee", -- stopColor
  accent_comp  = "#c8fff6", -- iconAccentCompliment
  cyan         = "#ec9cb2", -- constantColor
  yellow       = "#89acf6", -- classNameColor
  pink         = "#9f73ea", -- keywordColor
  green        = "#F6E9CB", -- stringColor
  blue         = "#788a8b", -- htmlTagColor
  key_green    = "#61ead9", -- keyColor
  purple       = "#fca7fa", -- iconSecondaryBlend
  border       = "#424648", -- borderColor
  red          = "#FF5555",
}
