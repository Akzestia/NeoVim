-- colors/Hatsune_Miku.lua
-- Auto-generated from miku.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Hatsune_Miku"

local c = {
  bg           = "#2f3635", -- textEditorBackground
  bg_dark      = "#313939", -- secondaryBackground
  bg_header    = "#2c3333", -- headerColor
  bg_base      = "#293030", -- baseBackground
  bg_caret     = "#313938", -- caretRow
  bg_select    = "#4c7a76", -- selectionBackground
  bg_search    = "#654773", -- searchBackground
  bg_fold      = "#273431", -- foldedTextBackground
  bg_diff_del  = "#3C4240", -- diff.deleted
  bg_diff_add  = "#27342f", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#586f6d", -- disabledColor
  fg_comment   = "#666879", -- lineNumberColor
  fg_line_nr   = "#666879", -- lineNumberColor
  accent       = "#53b0b4", -- accentColor
  accent_stop  = "#68eede", -- stopColor
  accent_comp  = "#FF9CEA", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#F6E9CB", -- classNameColor
  pink         = "#7BF8E1", -- keywordColor
  green        = "#B5F6BA", -- stringColor
  blue         = "#60a498", -- htmlTagColor
  key_green    = "#95C8FA", -- keyColor
  purple       = "#7bb9fd", -- iconSecondaryBlend
  border       = "#2d3839", -- borderColor
  red          = "#FF5555",
}
