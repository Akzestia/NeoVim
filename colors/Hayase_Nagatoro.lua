-- colors/Hayase_Nagatoro.lua
-- Auto-generated from nagatoro.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Hayase_Nagatoro"

local c = {
  bg           = "#151515", -- textEditorBackground
  bg_dark      = "#171717", -- secondaryBackground
  bg_header    = "#1a1a1a", -- headerColor
  bg_base      = "#1d1d1d", -- baseBackground
  bg_caret     = "#1f1f1f", -- caretRow
  bg_select    = "#5d3e2f", -- selectionBackground
  bg_search    = "#255926", -- searchBackground
  bg_fold      = "#212121", -- foldedTextBackground
  bg_diff_del  = "#242426", -- diff.deleted
  bg_diff_add  = "#1d231d", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#6f6461", -- disabledColor
  fg_comment   = "#5d5550", -- lineNumberColor
  fg_line_nr   = "#5d5550", -- lineNumberColor
  accent       = "#d2824e", -- accentColor
  accent_stop  = "#a9b3bd", -- stopColor
  accent_comp  = "#1785ff", -- iconAccentCompliment
  cyan         = "#d776ae", -- constantColor
  yellow       = "#D233A2", -- classNameColor
  pink         = "#6d7fd4", -- keywordColor
  green        = "#95acbd", -- stringColor
  blue         = "#62e665", -- htmlTagColor
  key_green    = "#5cd7d7", -- keyColor
  purple       = "#5edcf1", -- iconSecondaryBlend
  border       = "#272626", -- borderColor
  red          = "#FF5555",
}
