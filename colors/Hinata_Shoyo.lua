-- colors/Hinata_Shoyo.lua
-- Auto-generated from shoyo.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Hinata_Shoyo"

local c = {
  bg           = "#201c37", -- textEditorBackground
  bg_dark      = "#1b1830", -- secondaryBackground
  bg_header    = "#24203c", -- headerColor
  bg_base      = "#26223d", -- baseBackground
  bg_caret     = "#2c2847", -- caretRow
  bg_select    = "#6a473d", -- selectionBackground
  bg_search    = "#195A80", -- searchBackground
  bg_fold      = "#2c2847", -- foldedTextBackground
  bg_diff_del  = "#353539", -- diff.deleted
  bg_diff_add  = "#243137", -- testScopeColor
  fg           = "#b0b0b0", -- foregroundColor
  fg_dim       = "#6f6f6f", -- disabledColor
  fg_comment   = "#55596c", -- lineNumberColor
  fg_line_nr   = "#55596c", -- lineNumberColor
  accent       = "#f58d02", -- accentColor
  accent_stop  = "#ff7d19", -- stopColor
  accent_comp  = "#f58d02", -- iconAccentCompliment
  cyan         = "#ec9cb2", -- constantColor
  yellow       = "#61ead9", -- classNameColor
  pink         = "#ab77ff", -- keywordColor
  green        = "#FFC32F", -- stringColor
  blue         = "#F8932B", -- htmlTagColor
  key_green    = "#84D0FF", -- keyColor
  purple       = "#7690ff", -- iconSecondaryBlend
  border       = "#363056", -- borderColor
  red          = "#FF5555",
}
