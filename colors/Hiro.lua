-- colors/Hiro.lua
-- Auto-generated from hiro.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Hiro"

local c = {
  bg           = "#16171A", -- textEditorBackground
  bg_dark      = "#121317", -- secondaryBackground
  bg_header    = "#16171a", -- headerColor
  bg_base      = "#1d1e22", -- baseBackground
  bg_caret     = "#272a2f", -- caretRow
  bg_select    = "#1d4a88", -- selectionBackground
  bg_search    = "#841B27", -- searchBackground
  bg_fold      = "#25272d", -- foldedTextBackground
  bg_diff_del  = "#2A2929", -- diff.deleted
  bg_diff_add  = "#162a1d", -- testScopeColor
  fg           = "#b0b0b0", -- foregroundColor
  fg_dim       = "#5b6071", -- disabledColor
  fg_comment   = "#4F5D76", -- lineNumberColor
  fg_line_nr   = "#4F5D76", -- lineNumberColor
  accent       = "#3877d1", -- accentColor
  accent_stop  = "#68d7e6", -- stopColor
  accent_comp  = "#6ee4f8", -- iconAccentCompliment
  cyan         = "#83F57F", -- constantColor
  yellow       = "#EA517A", -- classNameColor
  pink         = "#6a96e9", -- keywordColor
  green        = "#FDB8EB", -- stringColor
  blue         = "#AE9AFF", -- htmlTagColor
  key_green    = "#89CCEC", -- keyColor
  purple       = "#8bc1ff", -- iconSecondaryBlend
  border       = "#303136", -- borderColor
  red          = "#FF5555",
}
