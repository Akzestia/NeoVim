-- colors/Hiro_x_Zero_Two.lua
-- Auto-generated from hiro.x.zero.two.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Hiro_x_Zero_Two"

local c = {
  bg           = "#150b24", -- textEditorBackground
  bg_dark      = "#0d041c", -- secondaryBackground
  bg_header    = "#0f071a", -- headerColor
  bg_base      = "#150b24", -- baseBackground
  bg_caret     = "#23214b", -- caretRow
  bg_select    = "#29466c", -- selectionBackground
  bg_search    = "#801925", -- searchBackground
  bg_fold      = "#271a3d", -- foldedTextBackground
  bg_diff_del  = "#2A2638", -- diff.deleted
  bg_diff_add  = "#152220", -- testScopeColor
  fg           = "#b8b8b8", -- foregroundColor
  fg_dim       = "#645468", -- disabledColor
  fg_comment   = "#5F4E65", -- lineNumberColor
  fg_line_nr   = "#5F4E65", -- lineNumberColor
  accent       = "#c93939", -- accentColor
  accent_stop  = "#5960c1", -- stopColor
  accent_comp  = "#1a68fa", -- iconAccentCompliment
  cyan         = "#9CA2FF", -- constantColor
  yellow       = "#5FFF9F", -- classNameColor
  pink         = "#ec377e", -- keywordColor
  green        = "#7EACF8", -- stringColor
  blue         = "#8078EE", -- htmlTagColor
  key_green    = "#FF96FD", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#362f3e", -- borderColor
  red          = "#FF5555",
}
