-- colors/Ishtar_Dark.lua
-- Auto-generated from ishtar.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Ishtar_Dark"

local c = {
  bg           = "#110F10", -- textEditorBackground
  bg_dark      = "#0a0a06", -- secondaryBackground
  bg_header    = "#0d0b0c", -- headerColor
  bg_base      = "#0f0d0e", -- baseBackground
  bg_caret     = "#1A1913", -- caretRow
  bg_select    = "#553919", -- selectionBackground
  bg_search    = "#4B1212", -- searchBackground
  bg_fold      = "#191718", -- foldedTextBackground
  bg_diff_del  = "#21211E", -- diff.deleted
  bg_diff_add  = "#091202", -- testScopeColor
  fg           = "#c2c2c2", -- foregroundColor
  fg_dim       = "#6f6f6f", -- disabledColor
  fg_comment   = "#6c6d5b", -- lineNumberColor
  fg_line_nr   = "#6c6d5b", -- lineNumberColor
  accent       = "#f5c443", -- accentColor
  accent_stop  = "#fec144", -- stopColor
  accent_comp  = "#ffedd4", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#7C7C82", -- classNameColor
  pink         = "#db974d", -- keywordColor
  green        = "#a18649", -- stringColor
  blue         = "#e53935", -- htmlTagColor
  key_green    = "#357fbf", -- keyColor
  purple       = "#e8df7d", -- iconSecondaryBlend
  border       = "#1a1a00", -- borderColor
  red          = "#FF5555",
}
