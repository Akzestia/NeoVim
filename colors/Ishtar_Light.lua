-- colors/Ishtar_Light.lua
-- Auto-generated from ishtar.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Ishtar_Light"

local c = {
  bg           = "#fffefb", -- textEditorBackground
  bg_dark      = "#fcfcfa", -- secondaryBackground
  bg_header    = "#fffefb", -- headerColor
  bg_base      = "#fffffc", -- baseBackground
  bg_caret     = "#fffaed", -- caretRow
  bg_select    = "#fff5c7", -- selectionBackground
  bg_search    = "#FFC7C7", -- searchBackground
  ...
  accent       = "#f5a821", -- accentColor
  accent_stop  = "#ec081e", -- stopColor
  accent_comp  = "#3e8cee", -- iconAccentCompliment
  cyan         = "#4C94D6", -- constantColor
  yellow       = "#131f3b", -- classNameColor
  pink         = "#db974d", -- keywordColor
  green        = "#a18649", -- stringColor
  blue         = "#e53935", -- htmlTagColor
  key_green    = "#0d5fa6", -- keyColor
  purple       = "#43b3aa", -- iconSecondaryBlend
