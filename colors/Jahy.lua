-- colors/Jahy.lua
-- Auto-generated from jahy.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Jahy"

local c = {
  bg           = "#1b102e", -- textEditorBackground
  bg_dark      = "#220e29", -- secondaryBackground
  bg_header    = "#1e1430", -- headerColor
  bg_base      = "#221738", -- baseBackground
  bg_caret     = "#2f1336", -- caretRow
  bg_select    = "#452346", -- selectionBackground
  bg_search    = "#7B1212", -- searchBackground
  bg_fold      = "#2f143b", -- foldedTextBackground
  bg_diff_del  = "#231F31", -- diff.deleted
  bg_diff_add  = "#1c212d", -- testScopeColor
  fg           = "#cbcbcb", -- foregroundColor
  fg_dim       = "#655b6f", -- disabledColor
  fg_comment   = "#656079", -- lineNumberColor
  fg_line_nr   = "#656079", -- lineNumberColor
  accent       = "#874488", -- accentColor
  accent_stop  = "#e6be68", -- stopColor
  accent_comp  = "#e8cb85", -- iconAccentCompliment
  cyan         = "#EA7797", -- constantColor
  yellow       = "#E77FD5", -- classNameColor
  pink         = "#D53232", -- keywordColor
  green        = "#f3b085", -- stringColor
  blue         = "#8BEF85", -- htmlTagColor
  key_green    = "#eec45e", -- keyColor
  purple       = "#b98bff", -- iconSecondaryBlend
  border       = "#322252", -- borderColor
  red          = "#FF5555",
}
