-- colors/Kanna.lua
-- Auto-generated from kanna.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Kanna"

local c = {
  bg           = "#1a1426", -- textEditorBackground
  bg_dark      = "#150f20", -- secondaryBackground
  bg_header    = "#1a1526", -- headerColor
  bg_base      = "#1b1529", -- baseBackground
  bg_caret     = "#231a31", -- caretRow
  bg_select    = "#492744", -- selectionBackground
  bg_search    = "#665DA6", -- searchBackground
  bg_fold      = "#251832", -- foldedTextBackground
  bg_diff_del  = "#2D2A36", -- diff.deleted
  bg_diff_add  = "#181A24", -- testScopeColor
  fg           = "#d0d0d0", -- foregroundColor
  fg_dim       = "#6f6f6f", -- disabledColor
  fg_comment   = "#6a6679", -- lineNumberColor
  fg_line_nr   = "#6a6679", -- lineNumberColor
  accent       = "#46459e", -- accentColor
  accent_stop  = "#344acb", -- stopColor
  accent_comp  = "#6ee4f8", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#6AADFF", -- classNameColor
  pink         = "#d285fd", -- keywordColor
  green        = "#FAF7BA", -- stringColor
  blue         = "#BD84DD", -- htmlTagColor
  key_green    = "#FF357C", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#221f2e", -- borderColor
  red          = "#FF5555",
}
