-- colors/Kirino.lua
-- Auto-generated from kirino.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Kirino"

local c = {
  bg           = "#121e1c", -- textEditorBackground
  bg_dark      = "#182826", -- secondaryBackground
  bg_header    = "#121e1c", -- headerColor
  bg_base      = "#152321", -- baseBackground
  bg_caret     = "#221f28", -- caretRow
  bg_select    = "#3d213e", -- selectionBackground
  bg_search    = "#195A80", -- searchBackground
  bg_fold      = "#1b2d2a", -- foldedTextBackground
  bg_diff_del  = "#1F2F2D", -- diff.deleted
  bg_diff_add  = "#122f1b", -- testScopeColor
  fg           = "#cbcbcb", -- foregroundColor
  fg_dim       = "#5b6f6d", -- disabledColor
  fg_comment   = "#657978", -- lineNumberColor
  fg_line_nr   = "#657978", -- lineNumberColor
  accent       = "#6cb3b5", -- accentColor
  accent_stop  = "#e6be68", -- stopColor
  accent_comp  = "#83e5e0", -- iconAccentCompliment
  cyan         = "#EA7797", -- constantColor
  yellow       = "#E77FD5", -- classNameColor
  pink         = "#49e7d0", -- keywordColor
  green        = "#F6E9CB", -- stringColor
  blue         = "#8BEF85", -- htmlTagColor
  key_green    = "#eec45e", -- keyColor
  purple       = "#57ade2", -- iconSecondaryBlend
  border       = "#1e322f", -- borderColor
  red          = "#FF5555",
}
