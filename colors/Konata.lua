-- colors/Konata.lua
-- Auto-generated from konata.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Konata"

local c = {
  bg           = "#355082", -- textEditorBackground
  bg_dark      = "#344d82", -- secondaryBackground
  bg_header    = "#314978", -- headerColor
  bg_base      = "#334c7d", -- baseBackground
  bg_caret     = "#3d5d96", -- caretRow
  bg_select    = "#3a6c75", -- selectionBackground
  bg_search    = "#6a527e", -- searchBackground
  bg_fold      = "#3b5a91", -- foldedTextBackground
  bg_diff_del  = "#4F6387", -- diff.deleted
  bg_diff_add  = "#2d5572", -- testScopeColor
  fg           = "#f3edff", -- foregroundColor
  fg_dim       = "#93A5BA", -- disabledColor
  fg_comment   = "#ffffff", -- lineNumberColor
  fg_line_nr   = "#ffffff", -- lineNumberColor
  accent       = "#4bcf4c", -- accentColor
  accent_stop  = "#98ff3d", -- stopColor
  accent_comp  = "#6ee4f8", -- iconAccentCompliment
  cyan         = "#f6be8b", -- constantColor
  yellow       = "#cda8fa", -- classNameColor
  pink         = "#ffc9d7", -- keywordColor
  green        = "#fc9ee6", -- stringColor
  blue         = "#f4ffa2", -- htmlTagColor
  key_green    = "#fffd9b", -- keyColor
  purple       = "#7173ff", -- iconSecondaryBlend
  border       = "#3e5d99", -- borderColor
  red          = "#FF5555",
}
