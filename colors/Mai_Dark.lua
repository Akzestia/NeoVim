-- colors/Mai_Dark.lua
-- Auto-generated from mai.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Mai_Dark"

local c = {
  bg           = "#242448", -- textEditorBackground
  bg_dark      = "#272750", -- secondaryBackground
  bg_header    = "#25254e", -- headerColor
  bg_base      = "#25254B", -- baseBackground
  bg_caret     = "#2d2d52", -- caretRow
  bg_select    = "#235161", -- selectionBackground
  bg_search    = "#4a3a71", -- searchBackground
  bg_fold      = "#2e3149", -- foldedTextBackground
  bg_diff_del  = "#383845", -- diff.deleted
  bg_diff_add  = "#252f4e", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#576f6a", -- disabledColor
  fg_comment   = "#61647b", -- lineNumberColor
  fg_line_nr   = "#61647b", -- lineNumberColor
  accent       = "#fee3cf", -- accentColor
  accent_stop  = "#757cca", -- stopColor
  accent_comp  = "#ecb6ff", -- iconAccentCompliment
  cyan         = "#FFEEA6", -- constantColor
  yellow       = "#61dba0", -- classNameColor
  pink         = "#50cefb", -- keywordColor
  green        = "#EFA554", -- stringColor
  blue         = "#AFC8F5", -- htmlTagColor
  key_green    = "#F9B2FF", -- keyColor
  purple       = "#db8dff", -- iconSecondaryBlend
  border       = "#2b2c57", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#fef4ff" })
