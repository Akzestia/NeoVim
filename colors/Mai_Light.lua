-- colors/Mai_Light.lua
-- Auto-generated from mai.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Mai_Light"

local c = {
  bg           = "#FAF2F1", -- textEditorBackground
  bg_dark      = "#f8efee", -- secondaryBackground
  bg_header    = "#fff7f6", -- headerColor
  bg_base      = "#fbf3f2", -- baseBackground
  bg_caret     = "#f1ecf2", -- caretRow
  bg_select    = "#b1b0d2", -- selectionBackground
  bg_search    = "#C3E8FF", -- searchBackground
  bg_fold      = "#f0e8e7", -- foldedTextBackground
  bg_diff_del  = "#E9E3E7", -- diff.deleted
  bg_diff_add  = "#f3f9ed", -- testScopeColor
  fg           = "#252427", -- foregroundColor
  fg_dim       = "#a2accb", -- disabledColor
  fg_comment   = "#aaaaaa", -- lineNumberColor
  fg_line_nr   = "#aaaaaa", -- lineNumberColor
  accent       = "#4f5287", -- accentColor
  accent_stop  = "#aba9dd", -- stopColor
  accent_comp  = "#4f5287", -- iconAccentCompliment
  cyan         = "#4C94D6", -- constantColor
  yellow       = "#4f5287", -- classNameColor
  pink         = "#7C75EF", -- keywordColor
  green        = "#d27f2d", -- stringColor
  blue         = "#4C5ED6", -- htmlTagColor
  key_green    = "#C869A3", -- keyColor
  purple       = "#5e5ace", -- iconSecondaryBlend
  border       = "#e6d8d7", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#2d4d21" })
