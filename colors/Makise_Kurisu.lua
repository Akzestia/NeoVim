-- colors/Makise_Kurisu.lua
-- Auto-generated from kurisu.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Makise_Kurisu"

local c = {
  bg           = "#170a0b", -- textEditorBackground
  bg_dark      = "#190d0d", -- secondaryBackground
  bg_header    = "#1a0e0e", -- headerColor
  bg_base      = "#1c1010", -- baseBackground
  bg_caret     = "#261112", -- caretRow
  bg_select    = "#391717", -- selectionBackground
  bg_search    = "#3F2E73", -- searchBackground
  bg_fold      = "#231010", -- foldedTextBackground
  bg_diff_del  = "#232121", -- diff.deleted
  bg_diff_add  = "#131a0f", -- testScopeColor
  fg           = "#c3c3c3", -- foregroundColor
  fg_dim       = "#6c6162", -- disabledColor
  fg_comment   = "#624849", -- lineNumberColor
  fg_line_nr   = "#624849", -- lineNumberColor
  accent       = "#8F60B5", -- accentColor
  accent_stop  = "#7717ee", -- stopColor
  accent_comp  = "#bca3aa", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#EC5D61", -- classNameColor
  pink         = "#BD93F9", -- keywordColor
  green        = "#4593f5", -- stringColor
  blue         = "#bca3aa", -- htmlTagColor
  key_green    = "#FF8C74", -- keyColor
  purple       = "#978bff", -- iconSecondaryBlend
  border       = "#2b1919", -- borderColor
  red          = "#FF5555",
}
