-- colors/Maple_Dark.lua
-- Auto-generated from maple.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Maple_Dark"

local c = {
  bg           = "#2d1d1d", -- textEditorBackground
  bg_dark      = "#2a1818", -- secondaryBackground
  bg_header    = "#2f1b1b", -- headerColor
  bg_base      = "#321f1f", -- baseBackground
  bg_caret     = "#352121", -- caretRow
  bg_select    = "#295043", -- selectionBackground
  bg_search    = "#734F2B", -- searchBackground
  bg_fold      = "#3c2727", -- foldedTextBackground
  bg_diff_del  = "#2F2A2A", -- diff.deleted
  bg_diff_add  = "#2e251b", -- testScopeColor
  fg           = "#cccccc", -- foregroundColor
  fg_dim       = "#6f6764", -- disabledColor
  fg_comment   = "#6c5b55", -- lineNumberColor
  fg_line_nr   = "#6c5b55", -- lineNumberColor
  accent       = "#46ab79", -- accentColor
  accent_stop  = "#52eeb4", -- stopColor
  accent_comp  = "#e2bb84", -- iconAccentCompliment
  cyan         = "#ec93a1", -- constantColor
  yellow       = "#ee7fdc", -- classNameColor
  pink         = "#FFD448", -- keywordColor
  green        = "#F6E9CB", -- stringColor
  blue         = "#fd9144", -- htmlTagColor
  key_green    = "#4fe1a9", -- keyColor
  purple       = "#f1b182", -- iconSecondaryBlend
  border       = "#412828", -- borderColor
  red          = "#FF5555",
}
