-- colors/Maple_Light.lua
-- Auto-generated from maple.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Maple_Light"

local c = {
  bg           = "#ffd091", -- textEditorBackground
  bg_dark      = "#f9ca92", -- secondaryBackground
  bg_header    = "#fdcd8f", -- headerColor
  bg_base      = "#ffd297", -- baseBackground
  bg_caret     = "#FFC392", -- caretRow
  bg_select    = "#ec9e74", -- selectionBackground
  bg_search    = "#AFF16A", -- searchBackground
  bg_fold      = "#FABD8C", -- foldedTextBackground
  bg_diff_del  = "#f0c792", -- diff.deleted
  bg_diff_add  = "#ead88a", -- testScopeColor
  fg           = "#101010", -- foregroundColor
  fg_dim       = "#8a7f48", -- disabledColor
  fg_comment   = "#693434", -- lineNumberColor
  fg_line_nr   = "#693434", -- lineNumberColor
  accent       = "#923A4E", -- accentColor
  accent_stop  = "#46ab79", -- stopColor
  accent_comp  = "#3e9e84", -- iconAccentCompliment
  cyan         = "#005CC5", -- constantColor
  yellow       = "#7748B7", -- classNameColor
  pink         = "#B03F0F", -- keywordColor
  green        = "#208D3B", -- stringColor
  blue         = "#2811B9", -- htmlTagColor
  key_green    = "#007972", -- keyColor
  purple       = "#7267d9", -- iconSecondaryBlend
  border       = "#f1bb73", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#651c10" })
