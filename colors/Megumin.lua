-- colors/Megumin.lua
-- Auto-generated from megumin.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Megumin"

local c = {
  bg           = "#2c2126", -- textEditorBackground
  bg_dark      = "#281d22", -- secondaryBackground
  bg_header    = "#2a1f24", -- headerColor
  bg_base      = "#271c21", -- baseBackground
  bg_caret     = "#31262b", -- caretRow
  bg_select    = "#563036", -- selectionBackground
  bg_search    = "#851B2A", -- searchBackground
  bg_fold      = "#33282d", -- foldedTextBackground
  bg_diff_del  = "#3E3839", -- diff.deleted
  bg_diff_add  = "#243125", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#585F6F", -- disabledColor
  fg_comment   = "#7b7373", -- lineNumberColor
  fg_line_nr   = "#7b7373", -- lineNumberColor
  accent       = "#a73035", -- accentColor
  accent_stop  = "#ee2e37", -- stopColor
  accent_comp  = "#e5c374", -- iconAccentCompliment
  cyan         = "#FC79BB", -- constantColor
  yellow       = "#FF8A5F", -- classNameColor
  pink         = "#a28a92", -- keywordColor
  green        = "#ffd866", -- stringColor
  blue         = "#a28a92", -- htmlTagColor
  key_green    = "#BA6462", -- keyColor
  purple       = "#d05353", -- iconSecondaryBlend
  border       = "#32262c", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#E2CB14" })
