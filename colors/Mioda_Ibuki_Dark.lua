-- colors/Mioda_Ibuki_Dark.lua
-- Auto-generated from ibuki.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Mioda_Ibuki_Dark"

local c = {
  bg           = "#191b1d", -- textEditorBackground
  bg_dark      = "#1a1e20", -- secondaryBackground
  bg_header    = "#17191b", -- headerColor
  bg_base      = "#141617", -- baseBackground
  bg_caret     = "#222526", -- caretRow
  bg_select    = "#452735", -- selectionBackground
  bg_search    = "#326283", -- searchBackground
  bg_fold      = "#343434", -- foldedTextBackground
