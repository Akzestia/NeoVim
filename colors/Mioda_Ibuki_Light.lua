-- colors/Mioda_Ibuki_Light.lua
-- Auto-generated from ibuki.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Mioda_Ibuki_Light"

local c = {
  bg           = "#ffeefd", -- textEditorBackground
  bg_dark      = "#FFEAF9", -- secondaryBackground
  bg_header    = "#ffeefd", -- headerColor
  bg_base      = "#ffedfe", -- baseBackground
  bg_caret     = "#f7dcf3", -- caretRow
  bg_select    = "#8EDBFF", -- selectionBackground
  bg_search    = "#EA8EFF", -- searchBackground
  bg_fold      = "#f9e8f7", -- foldedTextBackground
  bg_diff_del  = "#EFE2E9", -- diff.deleted
  bg_diff_add  = "#e7eff1", -- testScopeColor
  fg           = "#272426", -- foregroundColor
  fg_dim       = "#cba2c4", -- disabledColor
  fg_comment   = "#aaaaaa", -- lineNumberColor
  fg_line_nr   = "#aaaaaa", -- lineNumberColor
  accent       = "#DA46A7", -- accentColor
  accent_stop  = "#469fda", -- stopColor
  accent_comp  = "#ff69df", -- iconAccentCompliment
  cyan         = "#2F6AAD", -- constantColor
  yellow       = "#cb70a5", -- classNameColor
  pink         = "#C869A3", -- keywordColor
  green        = "#3193D7", -- stringColor
  blue         = "#3A8CB8", -- htmlTagColor
  key_green    = "#4174b3", -- keyColor
  purple       = "#3870ef", -- iconSecondaryBlend
  border       = "#ede1e9", -- borderColor
  red          = "#FF5555",
}
