-- colors/Misaka_Mikoto.lua
-- Auto-generated from mikoto.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Misaka_Mikoto"

local c = {
  bg           = "#0b173a", -- textEditorBackground
  bg_dark      = "#030e24", -- secondaryBackground
  bg_header    = "#0b1633", -- headerColor
  bg_base      = "#0d193b", -- baseBackground
  bg_caret     = "#112358", -- caretRow
  bg_select    = "#05649c", -- selectionBackground
  bg_search    = "#127B1B", -- searchBackground
  bg_fold      = "#16295e", -- foldedTextBackground
  bg_diff_del  = "#232C3E", -- diff.deleted
  bg_diff_add  = "#0a2832", -- testScopeColor
  fg           = "#dbdbdb", -- foregroundColor
  fg_dim       = "#565871", -- disabledColor
  fg_comment   = "#5d6680", -- lineNumberColor
  fg_line_nr   = "#5d6680", -- lineNumberColor
  accent       = "#3eb7e5", -- accentColor
  accent_stop  = "#58ebff", -- stopColor
  accent_comp  = "#57e1ee", -- iconAccentCompliment
  cyan         = "#EA7797", -- constantColor
  yellow       = "#8BEF85", -- classNameColor
  pink         = "#57e1ee", -- keywordColor
  green        = "#A2EEFC", -- stringColor
  blue         = "#7286F5", -- htmlTagColor
  key_green    = "#FFE35C", -- keyColor
  purple       = "#7fa8ff", -- iconSecondaryBlend
  border       = "#101f4a", -- borderColor
  red          = "#FF5555",
}
