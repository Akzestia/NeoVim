-- colors/Monika_Dark.lua
-- Auto-generated from monika.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Monika_Dark"

local c = {
  bg           = "#1d2115", -- textEditorBackground
  bg_dark      = "#1a1e12", -- secondaryBackground
  bg_header    = "#1D2115", -- headerColor
  bg_base      = "#1A1E12", -- baseBackground
  bg_caret     = "#24291a", -- caretRow
  bg_select    = "#30432B", -- selectionBackground
  bg_search    = "#2362A7", -- searchBackground
  bg_fold      = "#252D19", -- foldedTextBackground
  bg_diff_del  = "#38403A", -- diff.deleted
  bg_diff_add  = "#1b2610", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#505050", -- disabledColor
  fg_comment   = "#697966", -- lineNumberColor
  fg_line_nr   = "#697966", -- lineNumberColor
  accent       = "#388E3C", -- accentColor
  accent_stop  = "#FFFA11", -- stopColor
  accent_comp  = "#81d984", -- iconAccentCompliment
  cyan         = "#FF8FCA", -- constantColor
  yellow       = "#FFEA82", -- classNameColor
  pink         = "#3eae5d", -- keywordColor
  green        = "#94CFFF", -- stringColor
  blue         = "#3eae5d", -- htmlTagColor
  key_green    = "#ABFFAF", -- keyColor
  purple       = "#5a92fc", -- iconSecondaryBlend
  border       = "#202416", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#ececec" })
