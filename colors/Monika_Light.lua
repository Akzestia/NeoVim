-- colors/Monika_Light.lua
-- Auto-generated from monika.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Monika_Light"

local c = {
  bg           = "#f2fff0", -- textEditorBackground
  bg_dark      = "#edffec", -- secondaryBackground
  bg_header    = "#f2fff0", -- headerColor
  bg_base      = "#f3fff4", -- baseBackground
  bg_caret     = "#dcf7e0", -- caretRow
  bg_select    = "#a9ecac", -- selectionBackground
  bg_search    = "#B9F4FF", -- searchBackground
  bg_fold      = "#def6f3", -- foldedTextBackground
  bg_diff_del  = "#DFEFE6", -- diff.deleted
  bg_diff_add  = "#dcf6e1", -- testScopeColor
  fg           = "#252427", -- foregroundColor
  fg_dim       = "#a2cba3", -- disabledColor
  fg_comment   = "#8CAA8E", -- lineNumberColor
  fg_line_nr   = "#8CAA8E", -- lineNumberColor
  accent       = "#388E3C", -- accentColor
  accent_stop  = "#5EEF1B", -- stopColor
  accent_comp  = "#58c7a9", -- iconAccentCompliment
  cyan         = "#4C94D6", -- constantColor
  yellow       = "#9A9E20", -- classNameColor
  pink         = "#2BBA37", -- keywordColor
  green        = "#da832e", -- stringColor
  blue         = "#1E8225", -- htmlTagColor
  key_green    = "#6D71DC", -- keyColor
  purple       = "#1c7851", -- iconSecondaryBlend
  border       = "#e2eee3", -- borderColor
  red          = "#FF5555",
}
