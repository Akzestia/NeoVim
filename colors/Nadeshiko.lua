-- colors/Nadeshiko.lua
-- Auto-generated from nadeshiko.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Nadeshiko"

local c = {
  bg           = "#2c1f26", -- textEditorBackground
  bg_dark      = "#2a1c23", -- secondaryBackground
  bg_header    = "#2f2128", -- headerColor
  bg_base      = "#34252e", -- baseBackground
  bg_caret     = "#392831", -- caretRow
  bg_select    = "#553854", -- selectionBackground
  bg_search    = "#195A80", -- searchBackground
  bg_fold      = "#392831", -- foldedTextBackground
  bg_diff_del  = "#343037", -- diff.deleted
  bg_diff_add  = "#2d3126", -- testScopeColor
  fg           = "#b0b0b0", -- foregroundColor
  fg_dim       = "#6f5b68", -- disabledColor
  fg_comment   = "#6a5a6c", -- lineNumberColor
  fg_line_nr   = "#6a5a6c", -- lineNumberColor
  accent       = "#78c6d0", -- accentColor
  accent_stop  = "#68d7e6", -- stopColor
  accent_comp  = "#b36083", -- iconAccentCompliment
  cyan         = "#AE9AFF", -- constantColor
  yellow       = "#61ead9", -- classNameColor
  pink         = "#ec9cb2", -- keywordColor
  green        = "#F6E9CB", -- stringColor
  blue         = "#ea8f73", -- htmlTagColor
  key_green    = "#61c1ea", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#43303c", -- borderColor
  red          = "#FF5555",
}
