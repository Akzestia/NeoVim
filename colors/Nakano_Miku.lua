-- colors/Nakano_Miku.lua
-- Auto-generated from miku.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Nakano_Miku"

local c = {
  bg           = "#244158", -- textEditorBackground
  bg_dark      = "#233f55", -- secondaryBackground
  bg_header    = "#24445b", -- headerColor
  bg_base      = "#25475e", -- baseBackground
  bg_caret     = "#25475f", -- caretRow
  bg_select    = "#498192", -- selectionBackground
  bg_search    = "#2E6E61", -- searchBackground
  bg_fold      = "#274862", -- foldedTextBackground
  bg_diff_del  = "#3B4755", -- diff.deleted
  bg_diff_add  = "#244853", -- testScopeColor
  fg           = "#f3edff", -- foregroundColor
  fg_dim       = "#93A5BA", -- disabledColor
  fg_comment   = "#b9dfb6", -- lineNumberColor
  fg_line_nr   = "#b9dfb6", -- lineNumberColor
  accent       = "#A5F3FA", -- accentColor
  accent_stop  = "#53c8cf", -- stopColor
  accent_comp  = "#e88265", -- iconAccentCompliment
  cyan         = "#da8d97", -- constantColor
  yellow       = "#ba92f3", -- classNameColor
  pink         = "#60ff62", -- keywordColor
  green        = "#fffeaf", -- stringColor
  blue         = "#cda8fa", -- htmlTagColor
  key_green    = "#4BABFF", -- keyColor
  purple       = "#7c7efa", -- iconSecondaryBlend
  border       = "#26546b", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#dbfbfd" })
