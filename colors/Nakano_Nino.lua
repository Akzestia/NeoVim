-- colors/Nakano_Nino.lua
-- Auto-generated from nino.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Nakano_Nino"

local c = {
  bg           = "#1c191d", -- textEditorBackground
  bg_dark      = "#221c23", -- secondaryBackground
  bg_header    = "#1f1a1f", -- headerColor
  bg_base      = "#1a161c", -- baseBackground
  bg_caret     = "#272328", -- caretRow
  bg_select    = "#452735", -- selectionBackground
  bg_search    = "#35637C", -- searchBackground
  bg_fold      = "#252126", -- foldedTextBackground
  bg_diff_del  = "#262626", -- diff.deleted
  bg_diff_add  = "#1f211f", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#6f6f6f", -- disabledColor
  fg_comment   = "#666879", -- lineNumberColor
  fg_line_nr   = "#666879", -- lineNumberColor
  accent       = "#d45575", -- accentColor
  accent_stop  = "#68c4ee", -- stopColor
  accent_comp  = "#4fb2e7", -- iconAccentCompliment
  cyan         = "#ff858c", -- constantColor
  yellow       = "#5ea7ff", -- classNameColor
  pink         = "#7ceec8", -- keywordColor
  green        = "#F6E3CC", -- stringColor
  blue         = "#8daeef", -- htmlTagColor
  key_green    = "#68c4ee", -- keyColor
  purple       = "#ea8bff", -- iconSecondaryBlend
  border       = "#232024", -- borderColor
  red          = "#FF5555",
}
