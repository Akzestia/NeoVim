-- colors/Nakano_Yotsuba.lua
-- Auto-generated from yotsuba.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Nakano_Yotsuba"

local c = {
  bg           = "#200909", -- textEditorBackground
  bg_dark      = "#1a0d20", -- secondaryBackground
  bg_header    = "#110c15", -- headerColor
  bg_base      = "#140e19", -- baseBackground
  bg_caret     = "#2d0d0d", -- caretRow
  bg_select    = "#622316", -- selectionBackground
  bg_search    = "#49357C", -- searchBackground
  bg_fold      = "#340e0e", -- foldedTextBackground
  bg_diff_del  = "#251E1C", -- diff.deleted
  bg_diff_add  = "#101513", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#4d4c50", -- disabledColor
  fg_comment   = "#F8E3D7", -- lineNumberColor
  fg_line_nr   = "#F8E3D7", -- lineNumberColor
  accent       = "#e86a44", -- accentColor
  accent_stop  = "#ee6323", -- stopColor
  accent_comp  = "#726dfa", -- iconAccentCompliment
  cyan         = "#9DACF6", -- constantColor
  yellow       = "#ffba2f", -- classNameColor
  pink         = "#ff858c", -- keywordColor
  green        = "#F6E3CC", -- stringColor
  blue         = "#A884EF", -- htmlTagColor
  key_green    = "#39e6a6", -- keyColor
  purple       = "#fa99ed", -- iconSecondaryBlend
  border       = "#231929", -- borderColor
  red          = "#FF5555",
}
