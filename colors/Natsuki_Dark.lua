-- colors/Natsuki_Dark.lua
-- Auto-generated from natsuki.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Natsuki_Dark"

local c = {
  bg           = "#35102c", -- textEditorBackground
  bg_dark      = "#330A2B", -- secondaryBackground
  bg_header    = "#2f0a27", -- headerColor
  bg_base      = "#310a29", -- baseBackground
  bg_caret     = "#441539", -- caretRow
  bg_select    = "#602b50", -- selectionBackground
  bg_search    = "#6d4cb9", -- searchBackground
  bg_fold      = "#441a35", -- foldedTextBackground
  bg_diff_del  = "#362B31", -- diff.deleted
  bg_diff_add  = "#182613", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#505050", -- disabledColor
  fg_comment   = "#796675", -- lineNumberColor
  fg_line_nr   = "#796675", -- lineNumberColor
  accent       = "#E94686", -- accentColor
  accent_stop  = "#F650FF", -- stopColor
  accent_comp  = "#E94686", -- iconAccentCompliment
  cyan         = "#9286FD", -- constantColor
  yellow       = "#FF9CD6", -- classNameColor
  pink         = "#FF9CD6", -- keywordColor
  green        = "#F6E9CB", -- stringColor
  blue         = "#EBABFD", -- htmlTagColor
  key_green    = "#9DC0FF", -- keyColor
  purple       = "#a94eff", -- iconSecondaryBlend
  border       = "#381927", -- borderColor
  red          = "#FF5555",
}
