-- colors/Ram.lua
-- Auto-generated from ram.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Ram"

local c = {
  bg           = "#342c34", -- textEditorBackground
  bg_dark      = "#373139", -- secondaryBackground
  bg_header    = "#2b252b", -- headerColor
  bg_base      = "#302930", -- baseBackground
  bg_caret     = "#353139", -- caretRow
  bg_select    = "#7a546f", -- selectionBackground
  bg_search    = "#4C637A", -- searchBackground
  bg_fold      = "#322634", -- foldedTextBackground
  bg_diff_del  = "#3B393A", -- diff.deleted
  bg_diff_add  = "#2c3436", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#6c586f", -- disabledColor
  fg_comment   = "#666879", -- lineNumberColor
  fg_line_nr   = "#666879", -- lineNumberColor
  accent       = "#e594bf", -- accentColor
  accent_stop  = "#e565ee", -- stopColor
  accent_comp  = "#75cbb3", -- iconAccentCompliment
  cyan         = "#85FFEF", -- constantColor
  yellow       = "#FBFF90", -- classNameColor
  pink         = "#ef57bf", -- keywordColor
  green        = "#a1e9ff", -- stringColor
  blue         = "#C84EB8", -- htmlTagColor
  key_green    = "#9d8df6", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#362d39", -- borderColor
  red          = "#FF5555",
}
