-- colors/Raphtalia.lua
-- Auto-generated from raphtalia.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Raphtalia"

local c = {
  bg           = "#1e1710", -- textEditorBackground
  bg_dark      = "#1e160f", -- secondaryBackground
  bg_header    = "#1c140f", -- headerColor
  bg_base      = "#231a13", -- baseBackground
  bg_caret     = "#2b2016", -- caretRow
  bg_select    = "#5c3915", -- selectionBackground
  bg_search    = "#2A5F1E", -- searchBackground
  bg_fold      = "#2d2318", -- foldedTextBackground
  bg_diff_del  = "#282621", -- diff.deleted
  bg_diff_add  = "#1d2110", -- testScopeColor
  fg           = "#cccccc", -- foregroundColor
  fg_dim       = "#68635d", -- disabledColor
  fg_comment   = "#6c5f55", -- lineNumberColor
  fg_line_nr   = "#6c5f55", -- lineNumberColor
  accent       = "#8a3c3d", -- accentColor
  accent_stop  = "#ee8952", -- stopColor
  accent_comp  = "#918af5", -- iconAccentCompliment
  cyan         = "#8097e3", -- constantColor
  yellow       = "#FFD448", -- classNameColor
  pink         = "#f19992", -- keywordColor
  green        = "#FDC78C", -- stringColor
  blue         = "#d75e88", -- htmlTagColor
  key_green    = "#fd9144", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#30231a", -- borderColor
  red          = "#FF5555",
}
