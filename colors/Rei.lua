-- colors/Rei.lua
-- Auto-generated from rei.dark.master.definition.json
vim.cmd("hi clear")
...
local c = {
  bg           = "#191b1f", -- textEditorBackground
  bg_dark      = "#191b1a", -- secondaryBackground
  bg_header    = "#131514", -- headerColor
  bg_base      = "#171918", -- baseBackground
  bg_caret     = "#1f2125", -- caretRow
  bg_select    = "#25435a", -- selectionBackground
  bg_search    = "#6b232d", -- searchBackground
  bg_fold      = "#232529", -- foldedTextBackground
  bg_diff_del  = "#262626", -- diff.deleted
  bg_diff_add  = "#131d13", -- testScopeColor
  fg           = "#d2d2d2", -- foregroundColor
  fg_dim       = "#526f69", -- disabledColor
  fg_comment   = "#666879", -- lineNumberColor
  fg_line_nr   = "#666879", -- lineNumberColor
  accent       = "#b53241", -- accentColor
  accent_stop  = "#00e389", -- stopColor
  accent_comp  = "#78bcff", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#6AADFF", -- classNameColor
  pink         = "#788a8b", -- keywordColor
  green        = "#F6E3CC", -- stringColor
  blue         = "#89c0d9", -- htmlTagColor
  key_green    = "#45e68a", -- keyColor
  purple       = "#5390ff", -- iconSecondaryBlend
  border       = "#1e211f", -- borderColor
  red          = "#FF5555",
}
