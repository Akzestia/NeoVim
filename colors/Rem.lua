-- colors/Rem.lua
-- Auto-generated from rem.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Rem"

local c = {
  bg           = "#2c2d34", -- textEditorBackground
  bg_dark      = "#313239", -- secondaryBackground
  bg_header    = "#25262b", -- headerColor
  bg_base      = "#292A30", -- baseBackground
  bg_caret     = "#313439", -- caretRow
  bg_select    = "#4C637A", -- selectionBackground
  bg_search    = "#7a546f", -- searchBackground
  bg_fold      = "#272e34", -- foldedTextBackground
  bg_diff_del  = "#36393B", -- diff.deleted
  ...
  accent_comp  = "#cf7dff", -- iconAccentCompliment
  cyan         = "#85FFEF", -- constantColor
  yellow       = "#FBFF90", -- classNameColor
  pink         = "#6893f3", -- keywordColor
  green        = "#F0A1FF", -- stringColor
  blue         = "#4E86C8", -- htmlTagColor
  key_green    = "#9d8df6", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#2d3439", -- borderColor
  red          = "#FF5555",
}
