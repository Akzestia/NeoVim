-- colors/Rias__Crimson.lua
-- Auto-generated from rias.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Rias__Crimson"

local c = {
  bg           = "#3E1010", -- textEditorBackground
  bg_dark      = "#401010", -- secondaryBackground
  bg_header    = "#3d1313", -- headerColor
  bg_base      = "#401112", -- baseBackground
  bg_caret     = "#491818", -- caretRow
  bg_select    = "#822e2e", -- selectionBackground
  bg_search    = "#181212", -- searchBackground
  bg_fold      = "#491818", -- foldedTextBackground
  bg_diff_del  = "#412a2b", -- diff.deleted
  bg_diff_add  = "#3d2313", -- testScopeColor
  fg           = "#fafafa", -- foregroundColor
  fg_dim       = "#6f4f4a", -- disabledColor
  fg_comment   = "#cdb0b0", -- lineNumberColor
  fg_line_nr   = "#cdb0b0", -- lineNumberColor
  accent       = "#e03943", -- accentColor
  accent_stop  = "#ec081e", -- stopColor
  accent_comp  = "#c94629", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#e03392", -- classNameColor
  pink         = "#C04750", -- keywordColor
  green        = "#9BBEE3", -- stringColor
  blue         = "#EA5B7B", -- htmlTagColor
  key_green    = "#eea367", -- keyColor
  purple       = "#ffde8b", -- iconSecondaryBlend
  border       = "#551818", -- borderColor
  red          = "#FF5555",
}
