-- colors/Rias__Onyx.lua
-- Auto-generated from rias.onyx.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Rias__Onyx"

local c = {
  bg           = "#100000", -- textEditorBackground
  bg_dark      = "#1c0607", -- secondaryBackground
  bg_header    = "#100000", -- headerColor
  bg_base      = "#130000", -- baseBackground
  bg_caret     = "#1e0607", -- caretRow
  bg_select    = "#390c10", -- selectionBackground
  bg_search    = "#0F625A", -- searchBackground
  bg_fold      = "#280a0b", -- foldedTextBackground
  bg_diff_del  = "#1c1214", -- diff.deleted
  bg_diff_add  = "#0f0a00", -- testScopeColor
  fg           = "#d8d8d8", -- foregroundColor
  fg_dim       = "#584445", -- disabledColor
  fg_comment   = "#97706f", -- lineNumberColor
  fg_line_nr   = "#97706f", -- lineNumberColor
  accent       = "#7C171F", -- accentColor
  accent_stop  = "#9a101f", -- stopColor
  accent_comp  = "#47C0B7", -- iconAccentCompliment
  cyan         = "#E356A7", -- constantColor
  yellow       = "#5a84dd", -- classNameColor
  pink         = "#27c0b4", -- keywordColor
  green        = "#F6E3CC", -- stringColor
  blue         = "#6297a2", -- htmlTagColor
  key_green    = "#b2dbe3", -- keyColor
  purple       = "#ea4747", -- iconSecondaryBlend
  border       = "#220000", -- borderColor
  red          = "#FF5555",
}
