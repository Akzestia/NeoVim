-- colors/Rimuru_Tempest.lua
-- Auto-generated from rimuru.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Rimuru_Tempest"

local c = {
  bg           = "#1c171d", -- textEditorBackground
  bg_dark      = "#151016", -- secondaryBackground
  bg_header    = "#211c22", -- headerColor
  bg_base      = "#262127", -- baseBackground
  bg_caret     = "#302931", -- caretRow
  bg_select    = "#29466c", -- selectionBackground
  bg_search    = "#195A80", -- searchBackground
  bg_fold      = "#302931", -- foldedTextBackground
  bg_diff_del  = "#323239", -- diff.deleted
  bg_diff_add  = "#202f21", -- testScopeColor
  fg           = "#d3d3d3", -- foregroundColor
  fg_dim       = "#685e6d", -- disabledColor
  fg_comment   = "#675a6c", -- lineNumberColor
  fg_line_nr   = "#675a6c", -- lineNumberColor
  accent       = "#d7cf8b", -- accentColor
  accent_stop  = "#e6e068", -- stopColor
  accent_comp  = "#6ee4f8", -- iconAccentCompliment
  cyan         = "#9CA2FF", -- constantColor
  yellow       = "#FFA38F", -- classNameColor
  pink         = "#5FFF9F", -- keywordColor
  green        = "#77C2FF", -- stringColor
  blue         = "#77BBFF", -- htmlTagColor
  key_green    = "#FF96FD", -- keyColor
  purple       = "#f6eda4", -- iconSecondaryBlend
  border       = "#3f3741", -- borderColor
  red          = "#FF5555",
}
