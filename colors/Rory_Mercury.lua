-- colors/Rory_Mercury.lua
-- Auto-generated from rory.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Rory_Mercury"

local c = {
  bg           = "#141417", -- textEditorBackground
  bg_dark      = "#111114", -- secondaryBackground
  bg_header    = "#18181b", -- headerColor
  bg_base      = "#161619", -- baseBackground
  bg_caret     = "#1a1a1d", -- caretRow
  bg_select    = "#502121", -- selectionBackground
  bg_search    = "#265579", -- searchBackground
  bg_fold      = "#191813", -- foldedTextBackground
  bg_diff_del  = "#232121", -- diff.deleted
  bg_diff_add  = "#151c18", -- testScopeColor
  fg           = "#c3c3c3", -- foregroundColor
  fg_dim       = "#6f6f6f", -- disabledColor
  fg_comment   = "#796666", -- lineNumberColor
  fg_line_nr   = "#796666", -- lineNumberColor
  accent       = "#b53241", -- accentColor
  accent_stop  = "#ee2726", -- stopColor
  accent_comp  = "#BD93F9", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#BD93F9", -- classNameColor
  pink         = "#e0474b", -- keywordColor
  green        = "#58A0F8", -- stringColor
  blue         = "#666f71", -- htmlTagColor
  key_green    = "#7F8E90", -- keyColor
  purple       = "#7b99fd", -- iconSecondaryBlend
  border       = "#261616", -- borderColor
  red          = "#FF5555",
}
