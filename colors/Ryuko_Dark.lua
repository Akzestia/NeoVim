-- colors/Ryuko_Dark.lua
-- Auto-generated from ryuko.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Ryuko_Dark"

local c = {
  bg           = "#2b3238", -- textEditorBackground
  bg_dark      = "#282f35", -- secondaryBackground
  bg_header    = "#2b3238", -- headerColor
  bg_base      = "#2f363c", -- baseBackground
  bg_caret     = "#2a3037", -- caretRow
  bg_select    = "#563036", -- selectionBackground
  bg_search    = "#2C5277", -- searchBackground
  bg_fold      = "#272e34", -- foldedTextBackground
  bg_diff_del  = "#3C4246", -- diff.deleted
  bg_diff_add  = "#2d3e3a", -- testScopeColor
  ...
  accent_comp  = "#dccf4a", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#6893f3", -- classNameColor
  pink         = "#e0474b", -- keywordColor
  green        = "#efa554", -- stringColor
  blue         = "#8C90E5", -- htmlTagColor
  key_green    = "#99B6D5", -- keyColor
  purple       = "#5f84f3", -- iconSecondaryBlend
  border       = "#30383d", -- borderColor
  red          = "#FF5555",
}
