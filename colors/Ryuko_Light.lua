-- colors/Ryuko_Light.lua
-- Auto-generated from ryuko.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Ryuko_Light"

local c = {
  bg           = "#ffffff", -- textEditorBackground
  bg_dark      = "#eef6ff", -- secondaryBackground
  bg_header    = "#f5f6f7", -- headerColor
  bg_base      = "#fafbfc", -- baseBackground
  bg_caret     = "#e6effc", -- caretRow
  bg_select    = "#74adec", -- selectionBackground
  bg_search    = "#BAB0F3", -- searchBackground
  bg_fold      = "#f6f6f6", -- foldedTextBackground
  bg_diff_del  = "#3d2b2b", -- diff.deleted
  bg_diff_add  = "#ecfded", -- testScopeColor
  fg           = "#101010", -- foregroundColor
  fg_dim       = "#74889f", -- disabledColor
  fg_comment   = "#344f69", -- lineNumberColor
  fg_line_nr   = "#344f69", -- lineNumberColor
  accent       = "#169ef2", -- accentColor
  accent_stop  = "#19e3d9", -- stopColor
  accent_comp  = "#549dce", -- iconAccentCompliment
  cyan         = "#005CC5", -- constantColor
  yellow       = "#7748B7", -- classNameColor
  pink         = "#B03F0F", -- keywordColor
  green        = "#0F92E3", -- stringColor
  blue         = "#2811B9", -- htmlTagColor
  key_green    = "#007972", -- keyColor
  purple       = "#796bde", -- iconSecondaryBlend
  border       = "#e5e5ee", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#161165" })
