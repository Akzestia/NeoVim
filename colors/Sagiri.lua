-- colors/Sagiri.lua
-- Auto-generated from sagiri.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Sagiri"

local c = {
  bg           = "#0a3b36", -- textEditorBackground
  bg_dark      = "#08332e", -- secondaryBackground
  bg_header    = "#0a3f39", -- headerColor
  bg_base      = "#0b443e", -- baseBackground
  bg_caret     = "#0b463f", -- caretRow
  bg_select    = "#052421", -- selectionBackground
  bg_search    = "#AD4B65", -- searchBackground
  bg_fold      = "#0c4b44", -- foldedTextBackground
  bg_diff_del  = "#27423F", -- diff.deleted
  bg_diff_add  = "#094d36", -- testScopeColor
  fg           = "#f3edff", -- foregroundColor
  fg_dim       = "#769382", -- disabledColor
  fg_comment   = "#ffffff", -- lineNumberColor
  fg_line_nr   = "#ffffff", -- lineNumberColor
  accent       = "#5eabb8", -- accentColor
  accent_stop  = "#98ff3d", -- stopColor
  accent_comp  = "#DE8172", -- iconAccentCompliment
  cyan         = "#82BAFF", -- constantColor
  yellow       = "#9FBBFF", -- classNameColor
  pink         = "#FFD448", -- keywordColor
  green        = "#53dac7", -- stringColor
  blue         = "#f3ff83", -- htmlTagColor
  key_green    = "#F1A4FA", -- keyColor
  purple       = "#83ee7b", -- iconSecondaryBlend
  border       = "#0d514a", -- borderColor
  red          = "#FF5555",
}
