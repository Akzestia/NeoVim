-- colors/Satsuki_Dark.lua
-- Auto-generated from satsuki.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Satsuki_Dark"

local c = {
  bg           = "#242729", -- textEditorBackground
  bg_dark      = "#1d2123", -- secondaryBackground
  bg_header    = "#212427", -- headerColor
  bg_base      = "#272b2d", -- baseBackground
  bg_caret     = "#2b2e31", -- caretRow
  bg_select    = "#5d2626", -- selectionBackground
  bg_search    = "#1A6020", -- searchBackground
  bg_fold      = "#2b2e31", -- foldedTextBackground
  bg_diff_del  = "#2F3334", -- diff.deleted
  bg_diff_add  = "#202a25", -- testScopeColor
  fg           = "#d3d3d3", -- foregroundColor
  fg_dim       = "#5c5151", -- disabledColor
  fg_comment   = "#596570", -- lineNumberColor
  fg_line_nr   = "#596570", -- lineNumberColor
  accent       = "#f03022", -- accentColor
  accent_stop  = "#ee2726", -- stopColor
  accent_comp  = "#faa150", -- iconAccentCompliment
  cyan         = "#96b7fb", -- constantColor
  yellow       = "#6893f3", -- classNameColor
  pink         = "#e24a3e", -- keywordColor
  green        = "#F6E9CB", -- stringColor
  blue         = "#ff6b75", -- htmlTagColor
  key_green    = "#46F263", -- keyColor
  purple       = "#7399ff", -- iconSecondaryBlend
  border       = "#32373a", -- borderColor
  red          = "#FF5555",
}
