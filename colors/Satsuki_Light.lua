-- colors/Satsuki_Light.lua
-- Auto-generated from satsuki.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Satsuki_Light"
...
local c = {
  ...
  bg_select    = "#748fec", -- selectionBackground
  bg_search    = "#9c8bf0", -- searchBackground
  ...
  accent       = "#275AB3", -- accentColor
  accent_stop  = "#32c5e3", -- stopColor
  accent_comp  = "#1785ff", -- iconAccentCompliment
  cyan         = "#005CC5", -- constantColor
  yellow       = "#7748B7", -- classNameColor
  pink         = "#13a78c", -- keywordColor
  green        = "#0F92E3", -- stringColor
  blue         = "#EE5C09", -- htmlTagColor
  key_green    = "#79074c", -- keyColor
