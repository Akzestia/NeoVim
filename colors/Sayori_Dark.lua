-- colors/Sayori_Dark.lua
-- Auto-generated from sayori.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Sayori_Dark"

local c = {
  bg           = "#111b2d", -- textEditorBackground
  bg_dark      = "#131d2d", -- secondaryBackground
  bg_header    = "#0e1b2f", -- headerColor
  bg_base      = "#0E1D31", -- baseBackground
  bg_caret     = "#17243c", -- caretRow
  bg_select    = "#234164", -- selectionBackground
  bg_search    = "#2F617B", -- searchBackground
  bg_fold      = "#1b2346", -- foldedTextBackground
  bg_diff_del  = "#2E313D", -- diff.deleted
  bg_diff_add  = "#122325", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#4b4b57", -- disabledColor
  fg_comment   = "#666879", -- lineNumberColor
  fg_line_nr   = "#666879", -- lineNumberColor
  accent       = "#00BCD4", -- accentColor
  accent_stop  = "#11FFFD", -- stopColor
  accent_comp  = "#1785ff", -- iconAccentCompliment
  cyan         = "#A486FD", -- constantColor
  yellow       = "#52FFA3", -- classNameColor
  pink         = "#3F77EF", -- keywordColor
  green        = "#FF89BA", -- stringColor
  blue         = "#7DA6FF", -- htmlTagColor
  key_green    = "#FFF37C", -- keyColor
  purple       = "#73b1f8", -- iconSecondaryBlend
  border       = "#1a1c2d", -- borderColor
  red          = "#FF5555",
}
