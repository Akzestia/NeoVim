-- colors/Senko.lua
-- Auto-generated from senko.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Senko"

local c = {
  bg           = "#FFE7CD", -- textEditorBackground
  bg_dark      = "#f5dfbe", -- secondaryBackground
  bg_header    = "#fce2c6", -- headerColor
  bg_base      = "#ffe8d1", -- baseBackground
  bg_caret     = "#f9e2c4", -- caretRow
  bg_select    = "#f4ac96", -- selectionBackground
  bg_search    = "#B3BFFA", -- searchBackground
  bg_fold      = "#f8e2c0", -- foldedTextBackground
  bg_diff_del  = "#E8D6C0", -- diff.deleted
  bg_diff_add  = "#e4deb2", -- testScopeColor
  fg           = "#073642", -- foregroundColor
  fg_dim       = "#bab19f", -- disabledColor
  fg_comment   = "#CD9774", -- lineNumberColor
  fg_line_nr   = "#CD9774", -- lineNumberColor
  accent       = "#cb3752", -- accentColor
  accent_stop  = "#ff8c39", -- stopColor
  accent_comp  = "#668cf1", -- iconAccentCompliment
  cyan         = "#E734A8", -- constantColor
  yellow       = "#3451b1", -- classNameColor
  pink         = "#BF1010", -- keywordColor
  green        = "#3492b1", -- stringColor
  blue         = "#972CA3", -- htmlTagColor
  key_green    = "#4B72D7", -- keyColor
  purple       = "#45bab0", -- iconSecondaryBlend
  border       = "#dbc8b4", -- borderColor
  red          = "#FF5555",
}
