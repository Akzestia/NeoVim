-- colors/Shigure.lua
-- Auto-generated from shigure.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Shigure"

local c = {
  bg           = "#e9e9ff", -- textEditorBackground
  bg_dark      = "#cccaff", -- secondaryBackground
  bg_header    = "#dad9ff", -- headerColor
  bg_base      = "#e5e5ff", -- baseBackground
  bg_caret     = "#d4d2ff", -- caretRow
  bg_select    = "#5756a2", -- selectionBackground
  bg_search    = "#F39AE9", -- searchBackground
  bg_fold      = "#ddddff", -- foldedTextBackground
  bg_diff_del  = "#D6D6EC", -- diff.deleted
  bg_diff_add  = "#d3e6ef", -- testScopeColor
  fg           = "#101010", -- foregroundColor
  fg_dim       = "#484d8a", -- disabledColor
  fg_comment   = "#38336b", -- lineNumberColor
  fg_line_nr   = "#38336b", -- lineNumberColor
  accent       = "#5e1f7f", -- accentColor
  accent_stop  = "#a661b5", -- stopColor
  accent_comp  = "#ff8bf5", -- iconAccentCompliment
  cyan         = "#005CC5", -- constantColor
  yellow       = "#7748B7", -- classNameColor
  pink         = "#410cb2", -- keywordColor
  green        = "#208D3B", -- stringColor
  blue         = "#2811B9", -- htmlTagColor
  key_green    = "#5E037E", -- keyColor
  purple       = "#8675fc", -- iconSecondaryBlend
  border       = "#d6d5fe", -- borderColor
  red          = "#FF5555",
}
