-- colors/Shima_Rin.lua
-- Auto-generated from shima.rin.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Shima_Rin"

local c = {
  bg           = "#2b303b", -- textEditorBackground
  bg_dark      = "#2c3039", -- secondaryBackground
  bg_header    = "#2e343e", -- headerColor
  bg_base      = "#323742", -- baseBackground
  bg_caret     = "#313a49", -- caretRow
  bg_select    = "#4f3a4e", -- selectionBackground
  bg_search    = "#195A80", -- searchBackground
  bg_fold      = "#323743", -- foldedTextBackground
  bg_diff_del  = "#30383E", -- diff.deleted
  bg_diff_add  = "#2e3a3c", -- testScopeColor
  fg           = "#b0b0b0", -- foregroundColor
  fg_dim       = "#5b606f", -- disabledColor
  fg_comment   = "#5a626c", -- lineNumberColor
  fg_line_nr   = "#5a626c", -- lineNumberColor
  accent       = "#6688ad", -- accentColor
  accent_stop  = "#e66895", -- stopColor
  accent_comp  = "#d067b3", -- iconAccentCompliment
  cyan         = "#ec9cb2", -- constantColor
  yellow       = "#89acf6", -- classNameColor
  pink         = "#ea73d6", -- keywordColor
  green        = "#F6E9CB", -- stringColor
  blue         = "#8698B2", -- htmlTagColor
  key_green    = "#61ead9", -- keyColor
  purple       = "#5ea4ec", -- iconSecondaryBlend
  border       = "#393e48", -- borderColor
  red          = "#FF5555",
}
