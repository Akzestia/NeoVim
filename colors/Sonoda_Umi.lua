-- colors/Sonoda_Umi.lua
-- Auto-generated from umi.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Sonoda_Umi"

local c = {
  bg           = "#15173c", -- textEditorBackground
  bg_dark      = "#151739", -- secondaryBackground
  bg_header    = "#191b44", -- headerColor
  bg_base      = "#15173e", -- baseBackground
  bg_caret     = "#181A46", -- caretRow
  bg_select    = "#272A59", -- selectionBackground
  bg_search    = "#47264B", -- searchBackground
  bg_fold      = "#191c49", -- foldedTextBackground
  bg_diff_del  = "#212140", -- diff.deleted
  bg_diff_add  = "#172741", -- testScopeColor
  fg           = "#d0d0d0", -- foregroundColor
  fg_dim       = "#585966", -- disabledColor
  fg_comment   = "#5e5e79", -- lineNumberColor
  fg_line_nr   = "#5e5e79", -- lineNumberColor
  accent       = "#EFA554", -- accentColor
  accent_stop  = "#344acb", -- stopColor
  accent_comp  = "#6ee4f8", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#78F5F0", -- classNameColor
  pink         = "#58b7ff", -- keywordColor
  green        = "#FFF6B3", -- stringColor
  blue         = "#FF357C", -- htmlTagColor
  key_green    = "#BD84DD", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#1c1f50", -- borderColor
  red          = "#FF5555",
}
