-- colors/Takanashi_Rikka.lua
-- Auto-generated from rikka.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Takanashi_Rikka"

local c = {
  bg           = "#1e1928", -- textEditorBackground
  bg_dark      = "#16121e", -- secondaryBackground
  bg_header    = "#1d1926", -- headerColor
  bg_base      = "#231e2d", -- baseBackground
  bg_caret     = "#2b233a", -- caretRow
  bg_select    = "#761d3a", -- selectionBackground
  bg_search    = "#277FA5", -- searchBackground
  bg_fold      = "#2b2538", -- foldedTextBackground
  bg_diff_del  = "#292231", -- diff.deleted
  bg_diff_add  = "#1c2f24", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#745c65", -- disabledColor
  fg_comment   = "#8e6e7b", -- lineNumberColor
  fg_line_nr   = "#8e6e7b", -- lineNumberColor
  accent       = "#dd2a62", -- accentColor
  accent_stop  = "#f3c61f", -- stopColor
  accent_comp  = "#FFB4F8", -- iconAccentCompliment
  cyan         = "#F9FC88", -- constantColor
  yellow       = "#67F5C4", -- classNameColor
  pink         = "#de4371", -- keywordColor
  green        = "#FFB4F8", -- stringColor
  blue         = "#AC99FC", -- htmlTagColor
  key_green    = "#8C92FC", -- keyColor
  purple       = "#a1a9ff", -- iconSecondaryBlend
  border       = "#2f283c", -- borderColor
  red          = "#FF5555",
}
