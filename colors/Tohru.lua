-- colors/Tohru.lua
-- Auto-generated from tohru.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Tohru"

local c = {
  bg           = "#ffe090", -- textEditorBackground
  bg_dark      = "#fde388", -- secondaryBackground
  bg_header    = "#f6d988", -- headerColor
  bg_base      = "#ffe591", -- baseBackground
  bg_caret     = "#ffe797", -- caretRow
  bg_select    = "#ec9e74", -- selectionBackground
  bg_search    = "#FF6684", -- searchBackground
  bg_fold      = "#ffe692", -- foldedTextBackground
  bg_diff_del  = "#edd289", -- diff.deleted
  bg_diff_add  = "#e8dd88", -- testScopeColor
  fg           = "#101010", -- foregroundColor
  fg_dim       = "#8a7f48", -- disabledColor
  fg_comment   = "#693434", -- lineNumberColor
  fg_line_nr   = "#693434", -- lineNumberColor
  accent       = "#d23c4b", -- accentColor
  accent_stop  = "#ff784b", -- stopColor
  accent_comp  = "#ff5d17", -- iconAccentCompliment
  cyan         = "#005CC5", -- constantColor
  yellow       = "#0E8D61", -- classNameColor
  pink         = "#A74503", -- keywordColor
  green        = "#005CC5", -- stringColor
  blue         = "#1a821b", -- htmlTagColor
  key_green    = "#176B82", -- keyColor
  purple       = "#e86508", -- iconSecondaryBlend
  border       = "#e8bf69", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#2f1206" })
