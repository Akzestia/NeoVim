-- colors/Tohsaka_Rin.lua
-- Auto-generated from rin.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Tohsaka_Rin"

local c = {
  bg           = "#161415", -- textEditorBackground
  bg_dark      = "#151314", -- secondaryBackground
  bg_header    = "#1b191a", -- headerColor
  bg_base      = "#191718", -- baseBackground
  bg_caret     = "#22191b", -- caretRow
  bg_select    = "#501F1F", -- selectionBackground
  bg_search    = "#225041", -- searchBackground
  bg_fold      = "#211D1E", -- foldedTextBackground
  bg_diff_del  = "#242424", -- diff.deleted
  bg_diff_add  = "#151e15", -- testScopeColor
  fg           = "#bbbbbb", -- foregroundColor
  fg_dim       = "#6f6f6f", -- disabledColor
  fg_comment   = "#847878", -- lineNumberColor
  fg_line_nr   = "#847878", -- lineNumberColor
  accent       = "#4c9697", -- accentColor
  accent_stop  = "#ee2726", -- stopColor
  accent_comp  = "#77e4f8", -- iconAccentCompliment
  cyan         = "#89dceb", -- constantColor
  yellow       = "#EFA554", -- classNameColor
  pink         = "#859395", -- keywordColor
  green        = "#72F8B5", -- stringColor
  blue         = "#FC5773", -- htmlTagColor
  key_green    = "#e0474b", -- keyColor
  purple       = "#818181", -- iconSecondaryBlend
  border       = "#211e1e", -- borderColor
  red          = "#FF5555",
}
