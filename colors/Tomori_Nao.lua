-- colors/Tomori_Nao.lua
-- Auto-generated from nao.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Tomori_Nao"

local c = {
  bg           = "#efe7de", -- textEditorBackground
  bg_dark      = "#e9e0db", -- secondaryBackground
  bg_header    = "#f1e7de", -- headerColor
  bg_base      = "#f5ede5", -- baseBackground
  bg_caret     = "#e2e1e2", -- caretRow
  bg_select    = "#b7c6ef", -- selectionBackground
  bg_search    = "#FF95CB", -- searchBackground
  bg_fold      = "#e7e1d9", -- foldedTextBackground
  bg_diff_del  = "#DED6C6", -- diff.deleted
  bg_diff_add  = "#d8e8c2", -- testScopeColor
  fg           = "#101010", -- foregroundColor
  fg_dim       = "#c9bea9", -- disabledColor
  fg_comment   = "#417db3", -- lineNumberColor
  fg_line_nr   = "#417db3", -- lineNumberColor
  accent       = "#276fd8", -- accentColor
  accent_stop  = "#4bbfff", -- stopColor
  accent_comp  = "#ffb617", -- iconAccentCompliment
  cyan         = "#C26010", -- constantColor
  yellow       = "#7748B7", -- classNameColor
  pink         = "#030BA0", -- keywordColor
  green        = "#296FCB", -- stringColor
  blue         = "#6A0FB8", -- htmlTagColor
  key_green    = "#098776", -- keyColor
  purple       = "#5680ff", -- iconSecondaryBlend
  border       = "#cac3bd", -- borderColor
  red          = "#FF5555",
}
