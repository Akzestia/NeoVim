-- colors/Vanilla.lua
-- Auto-generated from vanilla.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Vanilla"

local c = {
  bg           = "#2b2c3d", -- textEditorBackground
  bg_dark      = "#272935", -- secondaryBackground
  bg_header    = "#292a3a", -- headerColor
  bg_base      = "#2d2f43", -- baseBackground
  bg_caret     = "#333446", -- caretRow
  bg_select    = "#374872", -- selectionBackground
  bg_search    = "#3A6875", -- searchBackground
  bg_fold      = "#323449", -- foldedTextBackground
  bg_diff_del  = "#363842", -- diff.deleted
  bg_diff_add  = "#293237", -- testScopeColor
  fg           = "#cdcdcd", -- foregroundColor
  fg_dim       = "#5b5d6f", -- disabledColor
  fg_comment   = "#5a5e6c", -- lineNumberColor
  fg_line_nr   = "#5a5e6c", -- lineNumberColor
  accent       = "#9debff", -- accentColor
  accent_stop  = "#478ceb", -- stopColor
  accent_comp  = "#ffd755", -- iconAccentCompliment
  cyan         = "#5ddeda", -- constantColor
  yellow       = "#9d8df6", -- classNameColor
  pink         = "#FFD448", -- keywordColor
  green        = "#F6E9CB", -- stringColor
  blue         = "#f689f6", -- htmlTagColor
  key_green    = "#6a96e9", -- keyColor
  purple       = "#9475fc", -- iconSecondaryBlend
  border       = "#383a50", -- borderColor
  red          = "#FF5555",
}
