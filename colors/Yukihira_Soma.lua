-- colors/Yukihira_Soma.lua
-- Auto-generated from soma.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Yukihira_Soma"

local c = {
  bg           = "#09192b", -- textEditorBackground
  bg_dark      = "#06111d", -- secondaryBackground
  bg_header    = "#0c1c2e", -- headerColor
  bg_base      = "#122235", -- baseBackground
  bg_caret     = "#172c43", -- caretRow
  bg_select    = "#4f1d27", -- selectionBackground
  bg_search    = "#3B65B3", -- searchBackground
  bg_fold      = "#152940", -- foldedTextBackground
  bg_diff_del  = "#363B40", -- diff.deleted
  bg_diff_add  = "#092c2a", -- testScopeColor
  fg           = "#dbdbdb", -- foregroundColor
  fg_dim       = "#627282", -- disabledColor
  fg_comment   = "#5d6c80", -- lineNumberColor
  fg_line_nr   = "#5d6c80", -- lineNumberColor
  accent       = "#d13358", -- accentColor
  accent_stop  = "#dc3f52", -- stopColor
  accent_comp  = "#e55476", -- iconAccentCompliment
  cyan         = "#FFA6E1", -- constantColor
  yellow       = "#FF984B", -- classNameColor
  pink         = "#FFEF41", -- keywordColor
  green        = "#4BFF75", -- stringColor
  blue         = "#B39CFF", -- htmlTagColor
  key_green    = "#8ACAFF", -- keyColor
  purple       = "#a0a2ff", -- iconSecondaryBlend
  border       = "#233a55", -- borderColor
  red          = "#FF5555",
}
