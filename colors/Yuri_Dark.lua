-- colors/Yuri_Dark.lua
-- Auto-generated from yuri.dark.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Yuri_Dark"

local c = {
  bg           = "#422D5A", -- textEditorBackground
  bg_dark      = "#412D62", -- secondaryBackground
  bg_header    = "#442e5c", -- headerColor
  bg_base      = "#493162", -- baseBackground
  bg_caret     = "#473466", -- caretRow
  bg_select    = "#663995", -- selectionBackground
  bg_search    = "#B24CB6", -- searchBackground
  bg_fold      = "#3C1D55", -- foldedTextBackground
  bg_diff_del  = "#453C4A", -- diff.deleted
  bg_diff_add  = "#423658", -- testScopeColor
  fg           = "#DADADA", -- foregroundColor
  fg_dim       = "#AF9ECB", -- disabledColor
  fg_comment   = "#6f6679", -- lineNumberColor
  fg_line_nr   = "#6f6679", -- lineNumberColor
  accent       = "#AB47BC", -- accentColor
  accent_stop  = "#F667FF", -- stopColor
  accent_comp  = "#5f5be7", -- iconAccentCompliment
  cyan         = "#86FDB6", -- constantColor
  yellow       = "#FF9CD6", -- classNameColor
  pink         = "#B17BFD", -- keywordColor
  green        = "#B6B3FF", -- stringColor
  blue         = "#E7A1FA", -- htmlTagColor
  key_green    = "#F1FF86", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#4d3a63", -- borderColor
  red          = "#FF5555",
}
...
h(0, "Search",        { bg = c.bg_search, fg = "#e7e5f3" })
