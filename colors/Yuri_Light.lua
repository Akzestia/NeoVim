-- colors/Yuri_Light.lua
-- Auto-generated from yuri.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Yuri_Light"

local c = {
  bg           = "#f3f0ff", -- textEditorBackground
  bg_dark      = "#f5ecff", -- secondaryBackground
  bg_header    = "#f5f0ff", -- headerColor
  bg_base      = "#f7f3ff", -- baseBackground
  bg_caret     = "#e4dcf7", -- caretRow
  bg_select    = "#ada0d2", -- selectionBackground
  bg_search    = "#D798D6", -- searchBackground
  bg_fold      = "#eae5f6", -- foldedTextBackground
  bg_diff_del  = "#ECE3EC", -- diff.deleted
  ...
  accent       = "#ab74cb", -- accentColor
  accent_stop  = "#f595ff", -- stopColor
  accent_comp  = "#5450d2", -- iconAccentCompliment
  cyan         = "#4C94D6", -- constantColor
  yellow       = "#c26a9d", -- classNameColor
  pink         = "#7C75EF", -- keywordColor
  green        = "#2DA0D2", -- stringColor
  blue         = "#5E24BA", -- htmlTagColor
  key_green    = "#D579D0", -- keyColor
  purple       = "#9a8bff", -- iconSecondaryBlend
  border       = "#e2e3ee", -- borderColor
  red          = "#FF5555",
}
