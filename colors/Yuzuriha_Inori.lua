-- colors/Yuzuriha_Inori.lua
-- Auto-generated from inori.light.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Yuzuriha_Inori"

local c = {
  bg           = "#FFA772", -- textEditorBackground
  bg_dark      = "#f69b5c", -- secondaryBackground
  bg_header    = "#f8a56e", -- headerColor
  bg_base      = "#f6a873", -- baseBackground
  bg_caret     = "#fd9c8c", -- caretRow
  bg_select    = "#EC7F54", -- selectionBackground
  bg_search    = "#C89AF3", -- searchBackground
  bg_fold      = "#F8A881", -- foldedTextBackground
  bg_diff_del  = "#e29c77", -- diff.deleted
  bg_diff_add  = "#e0ad63", -- testScopeColor
  fg           = "#101010", -- foregroundColor
  fg_dim       = "#a17664", -- disabledColor
  fg_comment   = "#743333", -- lineNumberColor
  fg_line_nr   = "#743333", -- lineNumberColor
  accent       = "#ba1515", -- accentColor
  accent_stop  = "#c12e7a", -- stopColor
  accent_comp  = "#B11095", -- iconAccentCompliment
  cyan         = "#2B57A7", -- constantColor
  yellow       = "#7748B7", -- classNameColor
  pink         = "#99101B", -- keywordColor
  green        = "#413AC1", -- stringColor
  blue         = "#A406B4", -- htmlTagColor
  key_green    = "#0B6374", -- keyColor
  purple       = "#9248a5", -- iconSecondaryBlend
  border       = "#cd7e48", -- borderColor
  red          = "#FF5555",
}
