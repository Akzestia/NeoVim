-- colors/Zero_Two_Dark_Rose.lua
-- Auto-generated from zero.two.rose.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Zero_Two_Dark_Rose"

local c = {
  bg           = "#310f0f", -- textEditorBackground
  bg_dark      = "#330e0e", -- secondaryBackground
  bg_header    = "#300d0e", -- headerColor
  bg_base      = "#330f10", -- baseBackground
  bg_caret     = "#3c1414", -- caretRow
  bg_select    = "#531e1e", -- selectionBackground
  bg_search    = "#268B61", -- searchBackground
  bg_fold      = "#3c1515", -- foldedTextBackground
  bg_diff_del  = "#412a2b", -- diff.deleted
  bg_diff_add  = "#350d1c", -- testScopeColor
  fg           = "#efefef", -- foregroundColor
  fg_dim       = "#6f4f4a", -- disabledColor
  fg_comment   = "#a87975", -- lineNumberColor
  fg_line_nr   = "#a87975", -- lineNumberColor
  accent       = "#e4dad4", -- accentColor
  ...
  key_green    = "#C04750", -- keyColor
  purple       = "#efa2da", -- iconSecondaryBlend
  border       = "#481818", -- borderColor
  red          = "#FF5555",
}
