-- colors/Zero_Two_Light_Lily.lua
-- Auto-generated from zero.two.lily.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Zero_Two_Light_Lily"

local c = {
  bg           = "#fcfcfc", -- textEditorBackground
  bg_dark      = "#fcfcfc", -- secondaryBackground
  bg_header    = "#fafafa", -- headerColor
  bg_base      = "#fcfcfc", -- baseBackground
  bg_caret     = "#eef9fe", -- caretRow
  bg_select    = "#e9b4b8", -- selectionBackground
  bg_search    = "#B4E9DF", -- searchBackground
  ...
  yellow       = "#117aa6", -- classNameColor
  pink         = "#0da661", -- keywordColor
  green        = "#0EAAAF", -- stringColor
  blue         = "#5236B4", -- htmlTagColor
  key_green    = "#A62210", -- keyColor
  purple       = "#A62210", -- iconSecondaryBlend
  border       = "#eeeeee", -- borderColor
  red          = "#FF5555",
}
