-- colors/Zero_Two_Light_Sakura.lua
-- Auto-generated from zero.two.sakura.master.definition.json
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end

vim.g.colors_name = "Zero_Two_Light_Sakura"

local c = {
  bg           = "#ffe6ee", -- textEditorBackground
  bg_dark      = "#ffdeeb", -- secondaryBackground
  bg_header    = "#ffe5ef", -- headerColor
  bg_base      = "#ffeaf2", -- baseBackground
  bg_caret     = "#ffdbe5", -- caretRow
  bg_select    = "#c1e9d4", -- selectionBackground
  bg_search    = "#F1B0E7", -- searchBackground
  bg_fold      = "#ffcfde", -- foldedTextBackground
  bg_diff_del  = "#ECDDE6", -- diff.deleted
  bg_diff_add  = "#ecf5e6", -- testScopeColor
  fg           = "#252427", -- foregroundColor
  fg_dim       = "#d9abbb", -- disabledColor
  fg_comment   = "#BB9BB1", -- lineNumberColor
  fg_line_nr   = "#BB9BB1", -- lineNumberColor
  accent       = "#A62210", -- accentColor
  accent_stop  = "#ec081e", -- stopColor
  accent_comp  = "#009CEC", -- iconAccentCompliment
  cyan         = "#0d5fa6", -- constantColor
  yellow       = "#0F9497", -- classNameColor
  pink         = "#5236B4", -- keywordColor
  green        = "#E356A7", -- stringColor
  blue         = "#117aa6", -- htmlTagColor
  key_green    = "#A62210", -- keyColor
  purple       = "#bb4650", -- iconSecondaryBlend
  border       = "#f6c2d5", -- borderColor
  red          = "#FF5555",
}
