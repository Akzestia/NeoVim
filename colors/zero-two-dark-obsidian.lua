-- colors/Zero_Two.lua
-- Auto-generated from temp.json by port-doki-theme.mjs
vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
	vim.cmd("syntax reset")
end

vim.g.colors_name = "Zero_Two"

local c = {
	bg = "#17070e", -- textEditorBackground
	bg_dark = "#0e0509", -- secondaryBackground
	bg_header = "#150a0e", -- headerColor
	bg_base = "#1a0c12", -- baseBackground
	bg_caret = "#261d21", -- caretRow
	bg_select = "#174a2e", -- selectionBackground
	bg_search = "#872847", -- searchBackground
	bg_fold = "#21191d", -- foldedTextBackground
	bg_diff_del = "#2F292D", -- diff.deleted
	bg_diff_add = "#2a0f24", -- testScopeColor
	fg = "#bbbbbb", -- foregroundColor
	fg_dim = "#55685c", -- disabledColor
	fg_comment = "#53615B", -- lineNumberColor
	fg_line_nr = "#53615B", -- lineNumberColor
	accent = "#1ecd86", -- accentColor
	accent_stop = "#26ee65", -- stopColor
	accent_comp = "#b6ffbc", -- iconAccentCompliment
	cyan = "#2FAAF6", -- constantColor
	yellow = "#FFD448", -- classNameColor
	pink = "#FDB8EB", -- keywordColor
	green = "#39e6a6", -- stringColor
	blue = "#82B1EE", -- htmlTagColor
	key_green = "#B9F8BC", -- keyColor
	purple = "#efa2da", -- iconSecondaryBlend
	border = "#2c2226", -- borderColor
	red = "#FF5555", -- error (hardcoded sensible default)
}
...
h(0, "Search", { bg = c.bg_search, fg = "#fafafa" })
